#pragma region Local Var
	...
	Hash hLocal_diffmode = 0;
	Object obLocal_diffmode = 0;
	var uLocal_diffmode = 4;
	var uLocal_diffmode = 0;
	var uLocal_diffmode = 0;
	var uLocal_diffmode = 0;
	var uLocal_diffmode = 0;
...
void func_0xF9174A1C()
{
	...
	if (bLocal_diffmode || SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_deathmatch_controler")) <= 0)
		return;
	...
	if (!ENTITY::IS_ENTITY_DEAD(ped, false))
	{
		...
		{
			weaponTypeFromPickupType = OBJECT::GET_WEAPON_TYPE_FROM_PICKUP_TYPE(Global_diffmode.f_diffmode[i].f_diffmode);
			...
			else
			{
				for (j = 0; j <= 5; j = j + 1)
				{
					num = Global_diffmode.f_diffmode[i].f_diffmode[j];
				
					if (!func_0x8054862F(num, weaponTypeFromPickupType))
						Global_diffmode.f_diffmode[i].f_diffmode[j] = 0;
				}
			}
		}
				...
				if (dlcWeaponIndex != -1)
				{
					for (i = 0; i < FILES::GET_NUM_DLC_WEAPON_COMPONENTS(dlcWeaponIndex); i = i + 1)
					{
						if (FILES::GET_DLC_WEAPON_COMPONENT_DATA(dlcWeaponIndex, i, &ComponentDataPtr))
							if (ComponentDataPtr.f_diffmode == iParam0)
								return func_0xC9D82232(&(ComponentDataPtr.f_diffmode));
					}
				}
			}
			break;
...
int func_0x941A9C73(Hash hParam0, Any* panParam1)
{
	...
	for (i = 0; i < numDlcWeapons; i = i + 1)
	{
		if (FILES::GET_DLC_WEAPON_DATA(i, panParam1))
			if (panParam1->f_diffmode == hParam0)
				return i;
	}
...
void func_0xEFFC3CA9()
{
	...
	if (!func_0x3DC0CE5C() || IS_BIT_SET(Global_diffmode.f_diffmode, 2))
		return;

	for (i = 0; i <= *Global_diffmode.f_diffmode - 1; i = i + 1)
	{
		if (Global_diffmode.f_diffmode[i].f_diffmode == -624951259)
			Global_diffmode.f_diffmode[i].f_diffmode = joaat("WEAPON_BAT");
	}
...
void func_0x466660F2()
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		num = Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode;
		Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode = 0;
	
		if (IS_BIT_SET(num, 0))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 0);
	
		if (IS_BIT_SET(num, 1))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 1);
	
		if (IS_BIT_SET(num, 2))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 2);
	
		if (IS_BIT_SET(num, 3))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 3);
	
		if (IS_BIT_SET(num, 4))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 4);
	
		if (IS_BIT_SET(num, 5))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 5);
	
		if (IS_BIT_SET(num, 5))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 6);
	
		if (IS_BIT_SET(num, 5))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 7);
	
		if (IS_BIT_SET(num, 6))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 8);
	
		if (IS_BIT_SET(num, 7))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 9);
	
		if (IS_BIT_SET(num, 8))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 10);
	
		if (IS_BIT_SET(num, 9))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 11);
	
		if (IS_BIT_SET(num, 10))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 12);
	
		if (IS_BIT_SET(num, 11))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 13);
	
		if (IS_BIT_SET(num, 12))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 14);
	
		if (IS_BIT_SET(num, 13))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 15);
	
		if (IS_BIT_SET(num, 14))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 16);
	
		if (IS_BIT_SET(num, 15))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 17);
	
		if (IS_BIT_SET(num, 16))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 18);
	
		if (IS_BIT_SET(num, 17))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 19);
	
		if (IS_BIT_SET(num, 18))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 20);
	
		if (IS_BIT_SET(num, 19))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 21);
	
		if (IS_BIT_SET(num, 20))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 22);
	
		if (IS_BIT_SET(num, 21))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 23);
	
		if (IS_BIT_SET(num, 22))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 24);
	
		if (IS_BIT_SET(num, 23))
			MISC::SET_BIT(&(Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode), 25);
	}

	for (i = 0; i <= 31; i = i + 1)
	{
		num2 = Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode;
		Global_diffmode.f_diffmode[i].f_diffmode.f_diffmode = 0;
...
void func_0xC0CFEB4E()
{
	...
	if (func_0x62114499(4) != *Global_diffmode.f_diffmode)
		return;

	for (i = 0; i <= 3; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_diffmode[i]))
		{
		}
		else
		{
			for (j = 0; j <= 8; j = j + 1)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(closestObjectOfType))
					uLocal_diffmode[i] = closestObjectOfType;
			}
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_diffmode))
	{
		...
		for (k = 0; k <= 31; k = k + 1)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Global_diffmode.f_diffmode[k]))
			{
			}
			else if (ENTITY::GET_ENTITY_MODEL(Global_diffmode.f_diffmode[k]) != 961977741)
			{
			}
			else
			{
				obLocal_diffmode = Global_diffmode.f_diffmode[k];
			}
		}
	}
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "REWARD_KEYCARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict2, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01ABC", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01DEF", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_diffmode[i], &animDict3, "NO_REWARD_ch_Prop_CH_Sec_Cabinet_01GHI", 3))
			flag = false;
	}
	...
	if (*Global_diffmode.f_diffmode != -1)
	{
		...
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(obLocal_diffmode))
		{
		}
		else if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(obLocal_diffmode))
		{
		}
		else
		{
			OBJECT::ATTACH_PORTABLE_PICKUP_TO_PED(obLocal_diffmode, PLAYER::PLAYER_PED_ID());
		
			if (num != -1)
			{
				Global_diffmode.f_diffmode = 1;
				MISC::SET_BIT(&Global_diffmode.f_diffmode[num / 32], num % 32);
				Global_diffmode = { 10.61f, 0.11f, 210.2f };
			}
		}
	}
...
void func_0x8566D7EF()
{
	...
	if (IS_BIT_SET(*Global_diffmode.f_diffmode, 24) || OBJECT::IS_POINT_IN_ANGLED_AREA(Global_diffmode.f_diffmode, 1552.523f, -5461.145f, -10f, 10200f, -6599.993f, 200f, 3499.965f, false, true))
	{
...
void func_0xD6E31DD5()
{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_diffmode, uLocal_diffmode, fLocal_diffmode, false, true, 0) || SYSTEM::VDIST2(uLocal_diffmode, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) <= SYSTEM::POW(3f, 2f))
	{
...
void func_0x1F921654()
{
	...
	if (func_0x62114499(3) != *Global_diffmode.f_diffmode)
	{
		uLocal_diffmode = { func_0xA9B5EBA8() };
	...
	for (i = 0; i <= 79; i = i + 1)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Global_diffmode.f_diffmode[i]))
		{
		}
		else if (ENTITY::GET_ENTITY_MODEL(Global_diffmode.f_diffmode[i]) != -372985740)
		{
		}
		else
		{
			entity = Global_diffmode.f_diffmode[i];
		}
	}

	MISC::SET_BIT(&(Global_diffmode.f_diffmode[0].f_diffmode[1].f_diffmode), 3);
	...
	if (CUTSCENE::IS_CUTSCENE_PLAYING())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(entityIndexOfCutsceneEntity))
			uLocal_diffmode = { ENTITY::GET_ENTITY_COORDS(entityIndexOfCutsceneEntity, false) };
	}
	else if (!_IS_NULL_VECTOR(uLocal_diffmode))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_diffmode))
			_STOPWATCH_INITIALIZE(&uLocal_diffmode, false, false);
	
		if (func_0x932F3142(uLocal_diffmode, 5000, false))
		{
			uLocal_diffmode = { func_0xA9B5EBA8() };
			_STOPWATCH_DESTROY(&uLocal_diffmode);
		}
...
void func_0x408B2E23()
{
	...
	else if (bLocal_diffmode && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_diffmode = false;
	}
...
void func_0xF5241D2()
{
	...
	if (!func_0x47FF56D2() || Global_diffmode != 7 || SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("wardrobe_mp")) == 0 || Global_diffmode.f_diffmode < 0 || Global_diffmode.f_diffmode >= 125)
		return;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		else if (!Global_diffmode[Global_diffmode.f_diffmode])
		{
			if (Global_diffmode[Global_diffmode.f_diffmode] == func_0xC02FF737(i))
				Global_diffmode[Global_diffmode.f_diffmode] = true;
		}
	}
...
void func_0xCB5B3536()
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		else
		{
			...
			for (j = 0; j < 21; j = j + 1)
			{
				if (Global_diffmode[num].f_diffmode.f_diffmode[j])
				{
					hashNameForComponent = FILES::GET_HASH_NAME_FOR_COMPONENT(PLAYER::PLAYER_PED_ID(), 11, Global_diffmode[num].f_diffmode.f_diffmode[j][11], Global_diffmode[num].f_diffmode.f_diffmode[j][11]);
				
					if (hashNameForComponent == func_0xC02FF737(i))
						Global_diffmode[num].f_diffmode.f_diffmode[j] = false;
				}
			}
...
{
	return Global_diffmode.f_diffmode > 0;
}
...
void func_0x60E20BC()
{
	...
	if (func_0xDBD936D3())
	{
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), false, true) && !IS_BIT_SET(Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode, 22))
		{
		...
		else if (bLocal_diffmode && Global_diffmode)
		{
...
void func_0xECE2040D()
{
	...
	if (bLocal_diffmode && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY("AM_MP_ARCADE")) <= 0)
	{
		if (func_0x87650690())
...
void func_0x14C7EA4A(BOOL bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_diffmode.f_diffmode, 17))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				MISC::SET_BIT(&(Global_diffmode.f_diffmode), 17);
	...
	else if (IS_BIT_SET(Global_diffmode.f_diffmode, 17))
	{
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			MISC::CLEAR_BIT(&(Global_diffmode.f_diffmode), 17);
...
{
	return IS_BIT_SET(Global_diffmode.f_diffmode, 17);
}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_diffmode[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(Global_diffmode[plParam0].f_diffmode.f_diffmode) == 17;
...
void func_0xE581594F()
{
	...
	if (func_0xE7AE0A5(&uLocal_diffmode, 5000, false))
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			if (func_0x7BEA6B6B(i, true) == 1)
			{
				...
				for (j = 0; j < 4; j = j + 1)
				{
					if (Global_diffmode[j].f_diffmode == Global_diffmode.f_diffmode[i])
					{
						flag = true;
						break;
					}
...
void func_0x115F642(int iParam0, int iParam1, BOOL bParam2)
{
	...
	if (bParam2 && iParam1 != -1)
		Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode[iParam1] = iParam0;
		...
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && func_0xDBD936D3())
		{
			...
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_diffmode[i].f_diffmode > 0)
				{
					num4 = 0;
					num5 = -1;
					func_0xC5EEEB87(Global_diffmode[i].f_diffmode, &num4, &num5);
					...
					if (num2 == num6 && num3 == num5)
					{
						...
						{
							num7 = Global_diffmode[i].f_diffmode;
						
							if (num7 == -1)
							{
								for (j = 0; j < 3; j = j + 1)
								{
									if (Global_diffmode.f_diffmode[j] == Global_diffmode[i].f_diffmode)
									{
										num7 = j;
										break;
									}
...
void func_0x7BE3998D()
{
	...
	Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode.f_diffmode = 0;
	MISC::CLEAR_BIT(&(Global_diffmode.f_diffmode), 30);
	...
	if (bLocal_diffmode)
	{
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && func_0xDBD936D3() && !func_0x8B0CDA01(PLAYER::PLAYER_ID(), false))
		{
			...
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_diffmode[i].f_diffmode > 0)
				{
					unk.f_diffmode = Global_diffmode[i].f_diffmode;
					num = 0;
					num2 = -1;
					func_0xC5EEEB87(unk.f_diffmode, &num, &num2);
					func_0x523BD426(num, num2, &(unk.f_diffmode));
					num3 = GET_MP_INT_CHARACTER_STAT(func_0xE4DDEB52(i), -1);
				
					if (num3 > 0)
						unk.f_diffmode = num3;
					else
						func_0xC00D48A9(func_0xE4DDEB52(i), unk.f_diffmode, -1, true);
				
					if (unk.f_diffmode > 0)
						Global_diffmode[i].f_diffmode = unk.f_diffmode;
				}
			}
...
void func_0x70A5C900()
{
	...
	else if (bLocal_diffmode && func_0xDBD936D3())
	{
		Global_diffmode = 0;
		bLocal_diffmode = false;
	}
...
void func_0xF4FB34B2(int iParam0, BOOL bParam1)
{
	...
	for (i = 0; i < 18; i = i + 1)
	{
		if (bParam1)
		{
			...
			if (Global_diffmode.f_diffmode[i] == 0)
				if (num == -1)
					num = i;
		}
		else if (Global_diffmode.f_diffmode[i] == iParam0)
		{
	...
	if (bParam1)
		if (num > -1)
			Global_diffmode.f_diffmode[num] = iParam0;
...
BOOL func_0x14BA5D57(int iParam0, Player plParam1)
{
	...
	if (plParam1 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam1, false, true))
	{
		...
		if (iParam0 != 0)
		{
			...
			for (i = 0; i < 10; i = i + 1)
			{
				if (Global_diffmode.f_diffmode.f_diffmode[i] == player)
				{
					for (j = 0; j < 18; j = j + 1)
					{
						if (Global_diffmode.f_diffmode.f_diffmode[i].f_diffmode[j] == iParam0)
							return 1;
					}
				}
			}
...
BOOL func_0xB4CE8E51(Player plParam0, BOOL bParam1)
{
	...
	return func_0x6A46C9B4(Global_diffmode[plParam0].f_diffmode);
}

BOOL func_0xC62FC261(Player plParam0)
{
	if (func_0x6A46C9B4(plParam0))
		if (func_0x6A46C9B4(Global_diffmode[plParam0].f_diffmode))
...
{
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE() && !CAM::IS_SCREEN_FADED_OUT() && Global_diffmode.f_diffmode == 1 && Global_diffmode.f_diffmode.f_diffmode == joaat("seasparrow2"))
		Global_diffmode.f_diffmode = 0;
...
void func_0x313073A8()
{
	if (Global_diffmode.f_diffmode != -1)
	{
		if (!bLocal_diffmode)
		{
			iLocal_diffmode = PED::GET_PED_DRAWABLE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD);
			iLocal_diffmode = PED::GET_PED_TEXTURE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD);
			iLocal_diffmode = PED::GET_PED_PROP_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD, 1);
			iLocal_diffmode = PED::GET_PED_PROP_TEXTURE_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD);
			iLocal_diffmode = PED::GET_PED_DRAWABLE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_TEEF);
			iLocal_diffmode = PED::GET_PED_TEXTURE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_TEEF);
			bLocal_diffmode = true;
		}
		else if (iLocal_diffmode != PED::GET_PED_DRAWABLE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD) || iLocal_diffmode != PED::GET_PED_TEXTURE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD) || iLocal_diffmode != PED::GET_PED_PROP_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD, 1) || iLocal_diffmode != PED::GET_PED_PROP_TEXTURE_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD) || iLocal_diffmode != PED::GET_PED_DRAWABLE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_TEEF) || iLocal_diffmode != PED::GET_PED_TEXTURE_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_TEEF))
		{
			Global_diffmode.f_diffmode = -1;
			Global_diffmode.f_diffmode = -1;
			bLocal_diffmode = false;
	...
	for (i = 0; i < 27; i = i + 1)
	{
		...
		else if (num < 129)
		{
			if (!bParam5)
				if (func_0xAADB79C4(&unk15, num, characterType, pedParam0, -1))
					if (func_0x69D10458(pedParam0, &unk15, num, unk15.f_diffmode, unk15.f_diffmode, bParam3, bParam1, bParam4, bParam2))
						PED::ADD_PED_DECORATION_FROM_HASHES(pedParam0, unk15.f_diffmode, unk15.f_diffmode);
		}
		else if (num == 123)
		{
		...
		else
		{
			...
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(characterType, decorationIndex, &outComponent))
			{
				...
				{
					if (func_0x69D10458(pedParam0, &(outComponent.f_diffmode), num, outComponent.f_diffmode, outComponent.f_diffmode, bParam3, bParam1, bParam4, bParam2))
					{
						if (bParam6 || !func_0x88D35F02(outComponent.f_diffmode, outComponent.f_diffmode, num))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES(pedParam0, outComponent.f_diffmode, outComponent.f_diffmode);
							func_0xF1FAB61C(pedParam0, outComponent.f_diffmode, outComponent.f_diffmode);
						}
					}
				}
			}
...
BOOL func_0x88D35F02(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case joaat("mpExecutive_overlays"):
			switch (iParam1)
			{
				...
				case joaat("MP_exec_prizes_015_F"):
					if (_STAT_GET_PACKED_BOOL(7551, -1) || GET_MP_INT_CHARACTER_STAT(3792, -1) >= Global_diffmode.f_diffmode)
						return false;
		...
		case joaat("mpIndependence_overlays"):
			...
			if (!Global_diffmode.f_diffmode && !func_0x49421A98(iParam2, iParam1, false))
				return true;
			break;
		...
		case joaat("mpValentines_overlays"):
			if (!Global_diffmode.f_diffmode && !func_0x75CF6A28(iParam2, -1) && !Global_diffmode.f_diffmode)
				return true;
			break;
...
BOOL func_0x42C22233(Player plParam0, int iParam1, int iParam2)
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		...
		{
			case 0:
				return IS_BIT_SET(Global_diffmode[plParam0].f_diffmode.f_diffmode, num);
		}
	}
		...
		case joaat("STOMACH_RIGHT"):
			...
			if (hParam4 == joaat("CHEST_FULL") || hParam4 == joaat("CHEST_MID") && entityModel == joaat("MP_F_Freemode_01") || hParam4 == joaat("CHEST_RIGHT") || hParam4 == joaat("CHEST_STOM") || hParam4 == joaat("CHEST_STOM_FULL"))
			{
				if (!bParam6)
				{
					...
					else if (Global_diffmode == 13)
					{
						return false;
					}
					else if (Global_diffmode == 14)
					{
						return false;
					}
					else if (Global_diffmode == 15)
					{
						return false;
					}
					else if (Global_diffmode == 16)
					{
						return false;
					}
					else if (Global_diffmode == 71)
					{
						return false;
					}
					else if (Global_diffmode == 72)
					{
					}
				}
			}
...
BOOL func_0xAADB79C4(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4)
{
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(20000) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 1:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1400) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 2:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(9750) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 3:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2150) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 4:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 54:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12400) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 5:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 6:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 55:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1350) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 7:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1450) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 8:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2700) * Global_diffmode.f_diffmode), 7);
					break;
			
				case 9:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1200) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 10:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1500) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 11:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2650) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 56:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 12:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 57:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 58:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 59:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7400) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 60:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 17:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 18:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 19:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3600) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 20:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 21:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12500) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 22:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 23:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 24:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 25:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 26:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 27:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4800) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 28:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 61:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12350) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 62:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 63:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4500) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 64:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 65:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12300) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 29:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 30:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 31:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 66:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 32:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 33:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 34:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7250) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 35:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(11900) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 36:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2750) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 37:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1750) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 38:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 39:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3250) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 40:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1000) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 67:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 41:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 68:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 42:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5050) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 43:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2450) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 44:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 45:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 46:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 47:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1150) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 48:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 49:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7600) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 50:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2600) * Global_diffmode.f_diffmode), 2);
					break;
			
				case 51:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 52:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7450) * Global_diffmode.f_diffmode), 3);
					break;
			
				case 53:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_diffmode.f_diffmode), 0);
					break;
			
				case 69:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 1);
					break;
			
				case 70:
					func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_diffmode.f_diffmode), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 88:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 89:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
					...
					case 13:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 14:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 15:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 2);
						break;
				
					case 16:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 71:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 72:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 88:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 89:
						func_0xBE814674(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_diffmode.f_diffmode), 0);
						break;
					...
					case 14:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_diffmode.f_diffmode), 0);
						break;
				
					case 15:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 2);
						break;
				
					case 16:
						func_0xBE814674(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_diffmode.f_diffmode), 0);
						break;
				}
			}
			break;
	...
	if (iParam4 == 22)
		sParam0->f_diffmode = sParam0->f_diffmode * 2;

	return sParam0->f_diffmode != -1;
}
...
void func_0xC0E60EB1(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (numTattooShopDlcItems > 0 && decorationIndex < numTattooShopDlcItems)
	{
		if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iParam1, decorationIndex, &outComponent))
		{
			if (!FILES::IS_CONTENT_ITEM_LOCKED(outComponent))
			{
				sParam0->f_diffmode = iParam2;
				TEXT_LABEL_COPY(sParam0, { outComponent.f_diffmode }, 4);
				sParam0->f_diffmode = outComponent.f_diffmode;
				sParam0->f_diffmode = outComponent.f_diffmode;
				sParam0->f_diffmode = outComponent.f_diffmode;
				sParam0->f_diffmode = iParam1;
				sParam0->f_diffmode = outComponent.f_diffmode;
				sParam0->f_diffmode = iParam2 / 32;
				sParam0->f_diffmode = iParam2 % 32;
				sParam0->f_diffmode = outComponent.f_diffmode;
			}
		}
...
void func_0xBE814674(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)
{
	...
	sParam0->f_diffmode = MISC::GET_HASH_KEY(sParam4);
	sParam0->f_diffmode = MISC::GET_HASH_KEY(sParam5);
	sParam0->f_diffmode = MISC::GET_HASH_KEY(sParam6);
	sParam0->f_diffmode = iParam7;
	sParam0->f_diffmode = iParam8;
	sParam0->f_diffmode = iParam1 / 32;
	sParam0->f_diffmode = iParam1 % 32;
	sParam0->f_diffmode = iParam9;

	if (ENTITY::DOES_ENTITY_EXIST(pedParam2) && !PED::IS_PED_INJURED(pedParam2))
	{
		if (sParam0->f_diffmode == 0 || sParam0->f_diffmode == 1 || sParam0->f_diffmode == 2)
		{
		}
		else if (sParam0->f_diffmode == 3 || sParam0->f_diffmode == 4)
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "", 32);
		
			if (sParam0->f_diffmode == 13 || sParam0->f_diffmode == 14 || sParam0->f_diffmode == 15 || sParam0->f_diffmode == 16 || sParam0->f_diffmode == 71 || sParam0->f_diffmode == 72)
			{
			...
			{
				if (sParam0->f_diffmode == 0 || sParam0->f_diffmode == 1 || sParam0->f_diffmode == 2 || sParam0->f_diffmode == 4 || sParam0->f_diffmode == 3 || sParam0->f_diffmode == 54 || sParam0->f_diffmode == 5 || sParam0->f_diffmode == 6 || sParam0->f_diffmode == 55 || sParam0->f_diffmode == 7 || sParam0->f_diffmode == 8 || sParam0->f_diffmode == 9 || sParam0->f_diffmode == 10 || sParam0->f_diffmode == 11 || sParam0->f_diffmode == 56 || sParam0->f_diffmode == 12 || sParam0->f_diffmode == 57 || sParam0->f_diffmode == 58 || sParam0->f_diffmode == 59 || sParam0->f_diffmode == 60)
					TEXT_LABEL_APPEND_STRING(&unk, "FM_Tat_Award_", 32);
				else
					TEXT_LABEL_APPEND_STRING(&unk, "FM_Tat_", 32);
			
				if (ENTITY::GET_ENTITY_MODEL(pedParam2) == joaat("MP_M_Freemode_01") || sParam0->f_diffmode == 20)
					TEXT_LABEL_APPEND_STRING(&unk, "M_", 32);
				else
					TEXT_LABEL_APPEND_STRING(&unk, "F_", 32);
			...
			sParam0->f_diffmode = MISC::GET_HASH_KEY(&unk);
		
			if (PED::GET_PED_DECORATION_ZONE_FROM_HASHES(sParam0->f_diffmode, sParam0->f_diffmode) == 7)
				sParam0->f_diffmode = -1;
		}
	}
	...
	for (i = 26; i >= 0; i = i + -1)
	{
		if (bParam1)
		{
			if (Global_diffmode[i] == iParam0)
				return;
			else if (Global_diffmode[i] == -1)
				num = i;
		}
		else if (Global_diffmode[i] == iParam0)
		{
			Global_diffmode[i] = -1;
			return;
		}
...
Hash func_0x3B4EF0B2(Hash hParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (hParam0 == Global_diffmode.f_diffmode[iParam2] && iParam1 == Global_diffmode[iParam2] && Global_diffmode.f_diffmode[iParam2] != 0)
			return Global_diffmode.f_diffmode[iParam2];
		...
		Global_diffmode.f_diffmode[iParam2] = outComponent.f_diffmode;
		Global_diffmode[iParam2] = iParam1;
		Global_diffmode.f_diffmode[iParam2] = hParam0;
		return outComponent.f_diffmode;
	}
...
BOOL func_0xEAF08AE1(Ped pedParam0, int iParam1, int iParam2)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_diffmode[1] = { func_0x2257F879(entityModel, iParam1, iParam2, -1) };
	hash = Global_diffmode;
	hash2 = Global_diffmode;

	if (!IS_BIT_SET(Global_diffmode[1].f_diffmode, 0))
		return false;
	...
	if (iParam1 == 12)
	{
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num2] != -99)
			{
				...
				{
					Global_diffmode = hash;
					Global_diffmode = hash2;
					return false;
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_0xEAF08AE1(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_diffmode[2] = { func_0x2257F879(entityModel, 14, j, -1) };
								
									if (Global_diffmode[2].f_diffmode == i)
									{
										if (func_0xEAF08AE1(pedParam0, 14, j))
										{
											if (!func_0x4EAC6644(entityModel, iParam2, 14, j, &unk, &Global_diffmode[2]))
											{
												Global_diffmode = hash;
												Global_diffmode = hash2;
												return false;
					...
					else
					{
						...
						Global_diffmode[2] = { func_0x2257F879(entityModel, num2, num, -1) };
					
						if (!func_0x4EAC6644(entityModel, iParam2, num2, num, &unk, &Global_diffmode[2]))
						{
							Global_diffmode = hash;
							Global_diffmode = hash2;
							return false;
		...
		if (unk[10] != 0 && unk[10] != joaat("0") && unk.f_diffmode)
		{
			if (GET_MP_INT_CHARACTER_STAT(1759, Global_diffmode) != unk[10])
			{
				Global_diffmode = hash;
				Global_diffmode = hash2;
				return false;
	...
	{
		if (PED::GET_PED_PROP_INDEX(pedParam0, Global_diffmode[1].f_diffmode, 1) == Global_diffmode[1].f_diffmode && PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_diffmode[1].f_diffmode) == Global_diffmode[1].f_diffmode || Global_diffmode[1].f_diffmode == -1)
			return true;
	
		if (Global_diffmode[1].f_diffmode == PV_COMP_HEAD && IS_BIT_SET(Global_diffmode[1].f_diffmode, 6) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_diffmode, joaat("HELMET"), 1) && FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_diffmode) > 0)
		{
			shopPedApparelVariantPropCount = FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_diffmode);
		
			for (m = 0; m < shopPedApparelVariantPropCount; m = m + 1)
			{
				FILES::GET_VARIANT_PROP(Global_diffmode, m, &nameHash, &enumValue, &anchorPoint);
				...
				if (nameHash != 0 && nameHash != joaat("0"))
				{
					...
					if (outProp.f_diffmode == PED::GET_PED_PROP_INDEX(pedParam0, Global_diffmode[1].f_diffmode, 1) && outProp.f_diffmode == PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_diffmode[1].f_diffmode))
						return true;
				}
			}
		}
	...
	{
		if (Global_diffmode[1].f_diffmode == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_0xF91DA7A7(iParam1)) && Global_diffmode[1].f_diffmode == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_0xF91DA7A7(iParam1)))
			return true;
	
		if (iParam1 == 4)
		{
			Global_diffmode = Global_diffmode + 1;
...
BOOL func_0x4EAC6644(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	...
	if (iParam3 == -99 || iParam5->f_diffmode == -1)
		return true;
...
void func_0xE5FA3D79(var uParam0, Hash hParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 != 0 && iParam2 != -99)
	{
		...
		{
			for (i = 0; i < itemHash.f_diffmode; i = i + 1)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_diffmode, i, &outPropVariant) && outPropVariant.f_diffmode != -1)
					if (outPropVariant != 0 && outPropVariant != -1 && outPropVariant != joaat("0"))
						uParam0->[outPropVariant.f_diffmode] = func_0x37A3B7AE(hParam1, outPropVariant, 14, num);
					else if (outPropVariant.f_diffmode != -1)
						uParam0->[outPropVariant.f_diffmode] = outPropVariant.f_diffmode;
			}
		}
	}
...
struct<17> func_0x10D20E1D(Hash hParam0, int iParam1)
{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			{
				case 0:
					if (Global_diffmode.f_diffmode.f_diffmode.f_diffmode[120])
				...
				case 5:
					func_0xEC425A3E(&unk, -99, -99, Global_diffmode.f_diffmode.f_diffmode.f_diffmode[0], Global_diffmode.f_diffmode.f_diffmode.f_diffmode[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_0xEC425A3E(&unk, -99, -99, Global_diffmode.f_diffmode.f_diffmode.f_diffmode[1], Global_diffmode.f_diffmode.f_diffmode.f_diffmode[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_0xEC425A3E(&unk, -99, -99, Global_diffmode.f_diffmode.f_diffmode.f_diffmode[2], Global_diffmode.f_diffmode.f_diffmode.f_diffmode[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_0xD805D094(var uParam0, Hash hParam1, int iParam2, int iParam3)
{
	...
	{
		for (i = 0; i < outfit.f_diffmode; i = i + 1)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(outfit.f_diffmode, i, &outComponentVariant))
			{
				if (outComponentVariant != 0 && outComponentVariant != -1 && outComponentVariant != joaat("0"))
				{
					if (outComponentVariant.f_diffmode == 10)
					{
						FILES::INIT_SHOP_PED_COMPONENT(&outComponent);
						FILES::GET_SHOP_PED_COMPONENT(outComponentVariant, &outComponent);
					
						if (outComponentVariant != outComponent.f_diffmode)
							uParam0->f_diffmode = 1;
					}
				
					if (outComponentVariant.f_diffmode == 10 && uParam0->f_diffmode)
					{
						uParam0->[func_0xF91DA7A7(outComponentVariant.f_diffmode)] = outComponentVariant;
						uParam0->f_diffmode = 1;
					}
					else
					{
						uParam0->[func_0xF91DA7A7(outComponentVariant.f_diffmode)] = func_0x37A3B7AE(hParam1, outComponentVariant, func_0xF91DA7A7(outComponentVariant.f_diffmode), num);
					}
				}
				else if (outComponentVariant.f_diffmode != -1)
				{
					uParam0->[func_0xF91DA7A7(outComponentVariant.f_diffmode)] = outComponentVariant.f_diffmode;
				}
			}
		}
	
		if (outfit.f_diffmode == 0)
			uParam0->[13] = -99;
		else
			uParam0->[13] = outfit.f_diffmode;
	}
...
void func_0xB745E49C(int iParam0)
{
	...
	func_0xA2DFD38C(&Global_diffmode[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_0xA2DFD38C(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10)
{
	...
	iParam0->f_diffmode = 0;
	*iParam0 = iParam9;
	iParam0->f_diffmode = iParam2 % 32;
	iParam0->f_diffmode = iParam2 / 32;
	iParam0->f_diffmode = iParam4;
	iParam0->f_diffmode = iParam5;
	iParam0->f_diffmode = iParam6;
	TEXT_LABEL_ASSIGN_STRING(&(iParam0->f_diffmode), sParam3, 16);
	iParam0->f_diffmode = iParam8;
	iParam0->f_diffmode = func_0xE4C61EBD(iParam8);

	if (iParam0->f_diffmode >= 10 && iParam0->f_diffmode >= 0 && iParam0->f_diffmode < 3)
	{
		!bParam10;
		iParam0->f_diffmode = 0;
	}
	...
	if (bParam7)
		MISC::SET_BIT(&(iParam0->f_diffmode), 3);

	if (bParam10)
	{
		MISC::SET_BIT(&(iParam0->f_diffmode), 0);
	
		if (iParam0->f_diffmode >= 0 && iParam0->f_diffmode < 3)
			MISC::SET_BIT(&(iParam0->f_diffmode), 5);
	
		MISC::SET_BIT(&(iParam0->f_diffmode), 1);
		MISC::SET_BIT(&(iParam0->f_diffmode), 2);
		MISC::SET_BIT(&(iParam0->f_diffmode), 6);
	
		if (func_0x937D8816(14))
			return;
	
		if (iParam1 == 1)
			if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_diffmode, joaat("REBREATHER"), 0))
				MISC::SET_BIT(&(iParam0->f_diffmode), 7);
	
		if (iParam1 == 12)
		{
			if (!func_0x8D68F96D(Global_diffmode, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_diffmode), 2);
		
			if (!func_0x8D68F96D(Global_diffmode, 2, true, true, -1))
				MISC::SET_BIT(&(iParam0->f_diffmode), 4);
		}
		else if (iParam1 == 13)
		{
		}
		...
		if (FILES::IS_CONTENT_ITEM_LOCKED(Global_diffmode))
		{
			MISC::CLEAR_BIT(&(iParam0->f_diffmode), 1);
			MISC::CLEAR_BIT(&(iParam0->f_diffmode), 0);
		}
	}
	else if (iParam0->f_diffmode >= 0 && iParam0->f_diffmode < 3)
	{
		MISC::SET_BIT(&(iParam0->f_diffmode), 0);
		MISC::SET_BIT(&(iParam0->f_diffmode), 5);
	
		if (func_0xDF4F0B01(iParam1, iParam0->f_diffmode, iParam0->f_diffmode, 0, iParam0->f_diffmode, 0, 0))
			MISC::SET_BIT(&(iParam0->f_diffmode), 1);
	
		if (func_0xDF4F0B01(iParam1, iParam0->f_diffmode, iParam0->f_diffmode, 1, iParam0->f_diffmode, 0, 0))
			MISC::SET_BIT(&(iParam0->f_diffmode), 2);
	
		if (!func_0xDF4F0B01(iParam1, iParam0->f_diffmode, iParam0->f_diffmode, 2, iParam0->f_diffmode, 0, 0))
			MISC::SET_BIT(&(iParam0->f_diffmode), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = GET_MP_INT_CHARACTER_STAT(func_0x4CEDF2DA(iParam1, iParam0->f_diffmode), Global_diffmode);
		
			if (IS_BIT_SET(num, iParam0->f_diffmode))
				MISC::SET_BIT(&(iParam0->f_diffmode), 1);
		
			num = GET_MP_INT_CHARACTER_STAT(func_0x789572FD(iParam1, iParam0->f_diffmode), Global_diffmode);
		
			if (IS_BIT_SET(num, iParam0->f_diffmode))
				MISC::SET_BIT(&(iParam0->f_diffmode), 2);
		
			if (func_0x805F0D09(iParam1, iParam0->f_diffmode, &num2))
			{
				num = GET_MP_INT_CHARACTER_STAT(num2, Global_diffmode);
...
BOOL func_0xDF4F0B01(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	{
		if (iParam5 == 1)
			MISC::SET_BIT(&Global_diffmode.f_diffmode[iParam1][iParam3], iParam4);
	
		if (iParam6 == 1)
			MISC::CLEAR_BIT(&Global_diffmode.f_diffmode[iParam1][iParam3], iParam4);
	
		return IS_BIT_SET(Global_diffmode.f_diffmode[iParam1][iParam3], iParam4);
	}
	else if (iParam0 == 1)
	{
		if (iParam5 == 1)
			MISC::SET_BIT(&Global_diffmode.f_diffmode[iParam1].f_diffmode[iParam3], iParam4);
	
		if (iParam6 == 1)
			MISC::CLEAR_BIT(&Global_diffmode.f_diffmode[iParam1].f_diffmode[iParam3], iParam4);
	
		return IS_BIT_SET(Global_diffmode.f_diffmode[iParam1].f_diffmode[iParam3], iParam4);
	}
	else if (iParam0 == 2)
	{
		if (iParam5 == 1)
...
BOOL func_0x1B8A3878(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5)
{
	...
	*uParam2 = 14835;
	...
	if (bParam4 && Global_diffmode || !bParam4 && bParam5)
	{
		switch (iParam1)
		{
			case 1:
...
void func_0xEDA496E8(int iParam0, Hash hParam1)
{
	...
	num = 0;
	Global_diffmode[0].f_diffmode = 4;
...
void func_0xE3509264(int iParam0, int iParam1, int iParam2, Hash hParam3)
{
	...
	num2 = Global_diffmode[0].f_diffmode;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				Global_diffmode = outfit.f_diffmode;
				Global_diffmode = outfit;
				func_0xA2DFD38C(&Global_diffmode[0], iParam0, iParam1, &(outfit.f_diffmode), 0, 0, outfit.f_diffmode, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_0xA2DFD38C(&Global_diffmode[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				if (outProp.f_diffmode == 0)
					num4 = 9;
				else if (outProp.f_diffmode == 1)
					num4 = 10;
				else if (outProp.f_diffmode == 2)
					num4 = 2;
				else if (outProp.f_diffmode == 3)
					num4 = 3;
				else if (outProp.f_diffmode == 4)
					num4 = 4;
				else if (outProp.f_diffmode == 5)
					num4 = 5;
				else if (outProp.f_diffmode == 6)
					num4 = 6;
				else if (outProp.f_diffmode == 7)
					num4 = 7;
				else if (outProp.f_diffmode == 8)
					num4 = 8;
				else
					num4 = -1;
			
				Global_diffmode = outProp.f_diffmode;
				Global_diffmode = outProp;
				func_0xA2DFD38C(&Global_diffmode[0], iParam0, iParam1, &(outProp.f_diffmode), outProp.f_diffmode, outProp.f_diffmode, outProp.f_diffmode, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_diffmode, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_diffmode != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_diffmode)
		{
			FILES::GET_SHOP_PED_COMPONENT(hParam3, &outComponent);
			Global_diffmode = outComponent.f_diffmode;
			Global_diffmode = outComponent;
			func_0xA2DFD38C(&Global_diffmode[0], iParam0, iParam1, &(outComponent.f_diffmode), outComponent.f_diffmode, outComponent.f_diffmode, outComponent.f_diffmode, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_diffmode, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_diffmode != 0);
			return;
		}
...
void func_0x859154FC(int iParam0, Hash hParam1)
{
	...
	if (num6 == 1)
	{
		...
		if (num7 >= 0 && num7 < 121)
		{
			...
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num7] * Global_diffmode.f_diffmode);
		}
	}
	else if (num6 == 2)
	{
		...
		if (num8 >= 0 && num8 < 24)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num8] * Global_diffmode.f_diffmode);
	}
	else if (num6 == 3)
	{
		num9 = iParam0 - 155;
		...
		if (num9 >= 0 && num9 < 128)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num9] * Global_diffmode.f_diffmode);
	}
	else if (num6 == 4)
	{
		num10 = iParam0 - 319;
		...
		if (num10 >= 0 && num10 < 10)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num10] * Global_diffmode.f_diffmode);
	}
	...
	if (iParam0 >= 327)
	{
		...
		if (Global_diffmode[0].f_diffmode > 0)
			if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_diffmode, joaat("HAT"), 1))
				Global_diffmode[0].f_diffmode = SYSTEM::ROUND(SYSTEM::TO_FLOAT(Global_diffmode[0].f_diffmode) * Global_diffmode.f_diffmode);
			else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_diffmode, joaat("GLASSES"), 1))
				Global_diffmode[0].f_diffmode = SYSTEM::ROUND(SYSTEM::TO_FLOAT(Global_diffmode[0].f_diffmode) * Global_diffmode.f_diffmode);
			else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_diffmode, joaat("WATCH"), 1))
				Global_diffmode[0].f_diffmode = SYSTEM::ROUND(SYSTEM::TO_FLOAT(Global_diffmode[0].f_diffmode) * Global_diffmode.f_diffmode);
	}
	else
	{
		func_0xA2DFD38C(&Global_diffmode[0], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}
...
void func_0x31CAA5FE(int iParam0, Hash hParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			if (Global_diffmode.f_diffmode != -1)
				value = Global_diffmode.f_diffmode;
			else
				value = 310;
			break;
	...
	value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode);
...
void func_0x8F60B7F6(int iParam0, Hash hParam1)
{
	...
	if (num6 >= 0 && num6 < 26)
		value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num6] * Global_diffmode.f_diffmode);
...
void func_0xE646E909(int iParam0, Hash hParam1)
{
	...
	switch (iParam0)
	{
		...
		case 47:
			...
			num2 = 13;
			value = 40;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[77]);
			break;
		...
		case 48:
			...
			num2 = 14;
			value = 40;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[78]);
			break;
		...
		case 50:
			...
			num2 = 0;
			value = 45;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[80]);
			break;
		...
		case 51:
			...
			num2 = 1;
			value = 60;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[81]);
			break;
		...
		case 57:
			...
			num2 = 7;
			value = 375;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[87]);
			break;
		...
		case 59:
			...
			num2 = 9;
			value = 90;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[89]);
			break;
		...
		case 71:
			...
			num2 = 0;
			value = 90;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[176]);
			break;
		...
		case 72:
			...
			num2 = 1;
			value = 95;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[177]);
			break;
		...
		case 73:
			...
			num2 = 2;
			value = 95;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[178]);
			break;
		...
		case 81:
			...
			num2 = 10;
			value = 150;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[186]);
			break;
		...
		case 82:
			...
			num2 = 11;
			value = 65;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[187]);
			break;
		...
		case 86:
			...
			num2 = 15;
			value = 145;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[191]);
			break;
		...
		case 94:
			...
			num2 = 7;
			value = 1560;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[199]);
			break;
		...
		case 95:
			...
			num2 = 8;
			value = 195;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[200]);
			break;
		...
		case 96:
			...
			num2 = 9;
			value = 200;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[201]);
			break;
		...
		case 103:
			...
			num2 = 0;
			value = 975;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[208]);
			break;
		...
		case 104:
			...
			num2 = 1;
			value = 2670;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[209]);
			break;
		...
		case 105:
			...
			num2 = 2;
			value = 480;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[210]);
			break;
		...
		case 106:
			...
			num2 = 3;
			value = 400;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[211]);
			break;
		...
		case 107:
			...
			num2 = 4;
			value = 2500;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[212]);
			break;
		...
		case 108:
			...
			num2 = 5;
			value = 2060;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[213]);
			break;
		...
		case 109:
			...
			num2 = 6;
			value = 2620;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[214]);
			break;
		...
		case 110:
			...
			num2 = 7;
			value = 475;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[215]);
			break;
		...
		case 111:
			...
			num2 = 8;
			value = 490;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[216]);
			break;
		...
		case 112:
			...
			num2 = 9;
			value = 2280;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[217]);
			break;
		...
		case 113:
			...
			num2 = 10;
			value = 485;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[218]);
			break;
		...
		case 114:
			...
			num2 = 11;
			value = 2390;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[219]);
			break;
		...
		case 115:
			...
			num2 = 12;
			value = 2610;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[220]);
			break;
		...
		case 116:
			...
			num2 = 13;
			value = 1450;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[221]);
			break;
		...
		case 117:
			...
			num2 = 14;
			value = 2720;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[222]);
			break;
		...
		case 118:
			...
			num2 = 15;
			value = 4995;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[223]);
			break;
		...
		case 120:
			...
			num2 = 0;
			value = 325;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[240]);
			break;
		...
		case 123:
			...
			num2 = 3;
			value = 130;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[243]);
			break;
		...
		case 130:
			...
			num2 = 10;
			value = 450;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[250]);
			break;
		...
		case 131:
			...
			num2 = 11;
			value = 465;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[251]);
			break;
	...
	if (iParam0 == 4 || iParam0 == 20)
	{
		if (func_0x75CF6A28(89, -1))
		{
			...
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(1250) * Global_diffmode.f_diffmode);
		}
		else
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(40) * Global_diffmode.f_diffmode[4]);
		}
	}
	else if (iParam0 == 7 || iParam0 == 23)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, "REW_LSB" /*Los Santos Belle V Neck*/, 16);
		value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(450) * Global_diffmode.f_diffmode);
	}
	else if (iParam0 == 9 || iParam0 == 25)
	{
		if (func_0x75CF6A28(87, -1))
		{
			...
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(500) * Global_diffmode.f_diffmode);
		}
		else
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(40) * Global_diffmode.f_diffmode[9]);
		}
	}
	else if (iParam0 >= 0 && iParam0 < 16)
	{
		...
		if (num6 >= 0 && num6 < 256)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num6]);
	}
	else if (iParam0 >= 16 && iParam0 < 32)
	{
		...
		if (num7 >= 0 && num7 < 256)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num7]);
	}
...
void func_0xE6D60F9B(int iParam0, Hash hParam1)
{
	...
	if (iParam0 == 4)
	{
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_RS" /*Rockstar V Neck*/, 16);
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(1250) * Global_diffmode.f_diffmode * Global_diffmode.f_diffmode);
		}
		else
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(40) * Global_diffmode.f_diffmode[4] * Global_diffmode.f_diffmode);
		}
	}
	else if (iParam0 == 7)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, "REW_LSB" /*Los Santos Belle V Neck*/, 16);
		value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(450) * Global_diffmode.f_diffmode * Global_diffmode.f_diffmode);
	}
	else if (iParam0 == 9)
	{
		if (func_0x75CF6A28(87, -1))
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_REDSK" /*Red Skull V Neck*/, 16);
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(500) * Global_diffmode.f_diffmode * Global_diffmode.f_diffmode);
		}
		else
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(40) * Global_diffmode.f_diffmode[9] * Global_diffmode.f_diffmode);
		}
	}
	else
	{
...
void func_0xA91A09EB(int iParam0, Hash hParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			num2 = 0;
			value = 500;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[0]);
			break;
		...
		case 1:
			...
			num2 = 0;
			value = 500;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[1]);
			break;
		...
		case 2:
			...
			num2 = 1;
			value = 495;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[2]);
			break;
		...
		case 3:
			...
			num2 = 2;
			value = 490;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[3]);
			break;
		...
		case 4:
			...
			num2 = 3;
			value = 485;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[4]);
			break;
		...
		case 5:
			...
			num2 = 4;
			value = 480;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[5]);
			break;
		...
		case 7:
			...
			num2 = 0;
			value = 440;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[6]);
			break;
		...
		case 8:
			...
			num2 = 1;
			value = 435;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[7]);
			break;
		...
		case 9:
			...
			num2 = 2;
			value = 430;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[8]);
			break;
		...
		case 10:
			...
			num2 = 3;
			value = 425;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[9]);
			break;
		...
		case 11:
			...
			num2 = 4;
			value = 420;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[10]);
			break;
		...
		case 13:
			...
			num2 = 0;
			value = 190;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[11]);
			break;
		...
		case 14:
			...
			num2 = 1;
			value = 185;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[12]);
			break;
		...
		case 15:
			...
			num2 = 2;
			value = 180;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[13]);
			break;
		...
		case 16:
			...
			num2 = 3;
			value = 175;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[14]);
			break;
		...
		case 17:
			...
			num2 = 4;
			value = 170;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[15]);
			break;
		...
		case 18:
			...
			num2 = 0;
			value = 295;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[16]);
			break;
		...
		case 19:
			...
			num2 = 1;
			value = 290;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[17]);
			break;
		...
		case 20:
			...
			num2 = 2;
			value = 285;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[18]);
			break;
		...
		case 21:
			...
			num2 = 3;
			value = 280;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[19]);
			break;
		...
		case 22:
			...
			num2 = 4;
			value = 275;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[20]);
			break;
		...
		case 24:
			...
			num2 = 0;
			value = 2000;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[21]);
			break;
		...
		case 25:
			...
			num2 = 1;
			value = 1995;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[22]);
			break;
		...
		case 26:
			...
			num2 = 2;
			value = 1990;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[23]);
			break;
		...
		case 27:
			...
			num2 = 3;
			value = 1985;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[24]);
			break;
		...
		case 28:
			...
			num2 = 4;
			value = 1980;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[25]);
			break;
		...
		case 30:
			...
			num2 = 0;
			value = 1150;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[26]);
			break;
		...
		case 31:
			...
			num2 = 1;
			value = 1145;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[27]);
			break;
		...
		case 32:
			...
			num2 = 2;
			value = 1140;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[28]);
			break;
		...
		case 33:
			...
			num2 = 3;
			value = 1135;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[29]);
			break;
		...
		case 34:
			...
			num2 = 4;
			value = 1130;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[30]);
			break;
		...
		case 35:
			...
			num2 = 0;
			value = 550;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[31]);
			break;
		...
		case 36:
			...
			num2 = 1;
			value = 545;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[32]);
			break;
		...
		case 37:
			...
			num2 = 2;
			value = 540;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[33]);
			break;
		...
		case 38:
			...
			num2 = 3;
			value = 535;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[34]);
			break;
		...
		case 39:
			...
			num2 = 4;
			value = 530;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[35]);
			break;
		...
		case 41:
			...
			num2 = 0;
			value = 580;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[36]);
			break;
		...
		case 42:
			...
			num2 = 1;
			value = 575;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[37]);
			break;
		...
		case 43:
			...
			num2 = 2;
			value = 570;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[38]);
			break;
		...
		case 44:
			...
			num2 = 3;
			value = 565;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[39]);
			break;
		...
		case 45:
			...
			num2 = 4;
			value = 560;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[40]);
			break;
		...
		case 47:
			...
			num2 = 0;
			value = 1100;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[41]);
			break;
		...
		case 48:
			...
			num2 = 1;
			value = 1095;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[42]);
			break;
		...
		case 49:
			...
			num2 = 2;
			value = 1090;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[43]);
			break;
		...
		case 50:
			...
			num2 = 3;
			value = 1085;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[44]);
			break;
		...
		case 51:
			...
			num2 = 4;
			value = 1080;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[45]);
			break;
		...
		case 53:
			...
			num2 = 0;
			value = 520;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[46]);
			break;
		...
		case 54:
			...
			num2 = 1;
			value = 515;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[47]);
			break;
		...
		case 55:
			...
			num2 = 2;
			value = 510;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[48]);
			break;
		...
		case 56:
			...
			num2 = 3;
			value = 505;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[49]);
			break;
		...
		case 57:
			...
			num2 = 4;
			value = 500;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[50]);
			break;
		...
		case 60:
			...
			num2 = 0;
			value = 395;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[51]);
			break;
		...
		case 61:
			...
			num2 = 1;
			value = 390;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[52]);
			break;
		...
		case 62:
			...
			num2 = 2;
			value = 385;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[53]);
			break;
		...
		case 63:
			...
			num2 = 3;
			value = 380;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[54]);
			break;
		...
		case 64:
			...
			num2 = 4;
			value = 375;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[55]);
			break;
		...
		case 67:
			...
			num2 = 0;
			value = 1050;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[56]);
			break;
		...
		case 68:
			...
			num2 = 1;
			value = 1045;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[57]);
			break;
		...
		case 69:
			...
			num2 = 2;
			value = 1040;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[58]);
			break;
		...
		case 70:
			...
			num2 = 3;
			value = 1035;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[59]);
			break;
		...
		case 71:
			...
			num2 = 4;
			value = 1030;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[60]);
			break;
		...
		case 73:
			...
			num2 = 0;
			value = 1200;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[61]);
			break;
		...
		case 74:
			...
			num2 = 1;
			value = 1195;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[62]);
			break;
		...
		case 75:
			...
			num2 = 2;
			value = 1190;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[63]);
			break;
		...
		case 76:
			...
			num2 = 3;
			value = 1185;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[64]);
			break;
		...
		case 77:
			...
			num2 = 4;
			value = 1180;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[65]);
			break;
		...
		case 79:
			...
			num2 = 0;
			value = 475;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[66]);
			break;
		...
		case 80:
			...
			num2 = 1;
			value = 470;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[67]);
			break;
		...
		case 81:
			...
			num2 = 2;
			value = 465;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[68]);
			break;
		...
		case 82:
			...
			num2 = 3;
			value = 460;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[69]);
			break;
		...
		case 83:
			...
			num2 = 4;
			value = 455;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[70]);
			break;
		...
		case 85:
			...
			num2 = 0;
			value = 950;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[71]);
			break;
		...
		case 86:
			...
			num2 = 1;
			value = 945;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[72]);
			break;
		...
		case 87:
			...
			num2 = 2;
			value = 940;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[73]);
			break;
		...
		case 88:
			...
			num2 = 3;
			value = 935;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[74]);
			break;
		...
		case 89:
			...
			num2 = 4;
			value = 930;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[75]);
			break;
...
void func_0x24B9D800(int iParam0, Hash hParam1)
{
	...
	num = 0;
	Global_diffmode[0].f_diffmode = 3;
	func_0xE3509264(num, iParam0, 0, hParam1);
	return;
}
...
void func_0xE646E909(int iParam0, Hash hParam1)
{
	...
	switch (iParam0)
	{
		...
		case 82:
			...
			num2 = 2;
			value = 50;
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[82]);
			break;
	...
	if (iParam0 == 23 || iParam0 == 231)
	{
		...
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(45) * Global_diffmode.f_diffmode[23]);
		}
	}
	...
	else if (iParam0 == 28 || iParam0 == 236)
	{
		...
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(55) * Global_diffmode.f_diffmode[28]);
		}
	}
	...
	else if (iParam0 >= 128 && iParam0 < 160)
	{
		...
		if (num8 >= 0 && num8 < 237)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num8]);
	}
	else if (iParam0 >= 192 && iParam0 < 224)
	{
		...
		if (num9 >= 0 && num9 < 237)
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(value) * Global_diffmode.f_diffmode[num9]);
	}
...
void func_0xE6D60F9B(int iParam0, Hash hParam1)
{
	...
	if (iParam0 == 23)
	{
		...
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(45) * Global_diffmode.f_diffmode[23] * Global_diffmode.f_diffmode);
		}
	}
	else if (iParam0 == 17)
	{
	...
	else if (iParam0 == 28)
	{
		...
		{
			value = SYSTEM::ROUND(SYSTEM::TO_FLOAT(55) * Global_diffmode.f_diffmode[28] * Global_diffmode.f_diffmode);
		}
	}
	else
	{
...
{
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = 0;
	Global_diffmode[0].f_diffmode = 0;
	Global_diffmode[0].f_diffmode = -1;
	Global_diffmode[0].f_diffmode = 0;
	Global_diffmode[0] = 0;
	TEXT_LABEL_ASSIGN_STRING(&(Global_diffmode[0].f_diffmode), "NO_LABEL", 16);
	return;
}
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_0xB4D52F0E(PLAYER::PLAYER_ID(), true) && Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode.f_diffmode != 0)
						{
							return 1;
						}
					}
...
BOOL func_0x55931638(Player plParam0, BOOL bParam1, int iParam2)
{
	...
	player = Global_diffmode[plParam0].f_diffmode;

	if (func_0x6A46C9B4(player) && Global_diffmode[player].f_diffmode.f_diffmode == iParam2)
		return 1;
...
BOOL func_0xEA053375(Player plParam0, int iParam1)
{
	if (func_0x6A46C9B4(plParam0))
		if (func_0x6A46C9B4(Global_diffmode[plParam0].f_diffmode))
			if (Global_diffmode[plParam0].f_diffmode == plParam0 && Global_diffmode[plParam0].f_diffmode.f_diffmode == iParam1)
				return true;
...
BOOL func_0xCD74A84A(Ped pedParam0)
{
	...
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		num = Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode;
...
{
	if (func_0x54BEFA8F(bParam0) || func_0x39484892() || func_0x22B3D50D(*Global_diffmode.f_diffmode))
		return true;
...
{
	return func_0x9CB2DA77(*Global_diffmode.f_diffmode);
}
...
{
	if (bParam0)
		return IS_BIT_SET(*Global_diffmode.f_diffmode, 12) && func_0xFEA78839();

	return IS_BIT_SET(*Global_diffmode.f_diffmode, 12);
}
...
void func_0x363E3964()
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(playersLastVehicle))
		hLocal_diffmode = ENTITY::GET_ENTITY_MODEL(playersLastVehicle);
	...
	if (!bLocal_diffmode)
	{
		closestVehicle = VEHICLE::GET_CLOSEST_VEHICLE(0f, 0f, -50f, 1f, hLocal_diffmode, 2);
...
void func_0x1774FC3F()
{
	...
	if (iLocal_diffmode != num || bLocal_diffmode != flag)
	{
		func_0xDEB37B1F(num, &uLocal_diffmode, &uLocal_diffmode, &fLocal_diffmode, &fLocal_diffmode);
		iLocal_diffmode = num;
		bLocal_diffmode = flag;
	}

	if (Global_diffmode.f_diffmode.f_diffmode == -1 && Global_diffmode.f_diffmode.f_diffmode != iLocal_diffmode)
		Global_diffmode.f_diffmode.f_diffmode = iLocal_diffmode;
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_diffmode, uLocal_diffmode, fLocal_diffmode, false, true, 0))
	{
		...
		num2 = MISC::ABSF(fLocal_diffmode - entityHeading);
		...
		for (i = 0; i < 32; i = i + 1)
		{
			if (func_0x8ACF6631(i, iLocal_diffmode))
				num3 = num3 + 1;
		}
	
		if (num3 == 0 || num3 == 1 && func_0x8ACF6631(_GET_BOSS_OF_LOCAL_PLAYER(), iLocal_diffmode))
			if (func_0x67F162DB())
				func_0xD40A0568(iLocal_diffmode);
	}
...
{
	Global_diffmode.f_diffmode = plParam0;
	return;
}
...
BOOL func_0x67F162DB()
{
	...
	if (func_0xB24070EF(PLAYER::PLAYER_ID()) || Global_diffmode.f_diffmode || Global_diffmode != 0 || HUD::IS_WARNING_MESSAGE_ACTIVE() || func_0x3BED6F11(PLAYER::PLAYER_ID()) || NETWORK::NETWORK_SESSION_IS_AWAITING_INVITE_RESPONSE() || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		return false;
	...
	if (func_0xC2ABD0AE() || func_0x14C810F0() || Global_diffmode.f_diffmode)
		return false;
	...
	if (Global_diffmode.f_diffmode || Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode == 148 || Global_diffmode || func_0xE8921B44(0) || func_0xB72C022E() || _IS_PLAYER_A_BEAST(PLAYER::PLAYER_ID()) || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED())
		return false;
...
{
	return Global_diffmode.f_diffmode.f_diffmode != -1;
}
...
BOOL func_0x295F4323(Player plParam0)
{
	...
	if (player != -1)
		return IS_BIT_SET(Global_diffmode[player].f_diffmode, 0);
...
BOOL func_0xB24070EF(Player plParam0)
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true) || Global_diffmode.f_diffmode)
	{
		flag = IS_BIT_SET(Global_diffmode[plParam0].f_diffmode, 1);
		return flag;
	}
...
{
	return IS_BIT_SET(Global_diffmode.f_diffmode, 7);
}
...
BOOL func_0xE50D2DA8(Player plParam0, int iParam1)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_diffmode[plParam0].f_diffmode.f_diffmode != -1 && func_0xEE599357(Global_diffmode[plParam0].f_diffmode.f_diffmode) == 29)
				return Global_diffmode[plParam0].f_diffmode.f_diffmode == iParam1;
...
BOOL func_0x2BB88AD0(int iParam0)
{
	...
	if (Global_diffmode[iParam0].f_diffmode)
		return false;
	...
	if (!Global_diffmode[iParam0].f_diffmode)
	{
		HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&(Global_diffmode[iParam0].f_diffmode));
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_diffmode);
	...
	else
	{
		...
		if (Global_diffmode[iParam0].f_diffmode)
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_diffmode[iParam0].f_diffmode));
		else
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_diffmode[iParam0].f_diffmode));
...
int func_0x54874B4C(char* sParam0)
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_diffmode[i].f_diffmode)) && MISC::ARE_STRINGS_EQUAL(&(Global_diffmode[i].f_diffmode), sParam0))
			return i;
	}
...
void func_0x6AF3BC1C()
{
	...
	if (num != -1 && iLocal_diffmode != num)
		iLocal_diffmode = num;

	if (iLocal_diffmode == -1)
		return;

	Global_diffmode.f_diffmode = 500f;
	Global_diffmode.f_diffmode = 500f;
	Global_diffmode.f_diffmode = 500f;
	Global_diffmode.f_diffmode = 500f;
	...
	{
		case 0:
			Global_diffmode.f_diffmode = 10000f;
			break;
...
{
	if (Global_diffmode && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appinternet")) > 0)
		return true;
...
BOOL func_0x70532CF7(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_diffmode[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(Global_diffmode[plParam0].f_diffmode.f_diffmode) == 29;
...
void func_0x109BC0D6()
{
	if (func_0x8BB4165B())
	{
		...
		{
			hLocal_diffmode = joaat("apa_heist_apart2_door");
		
			if (func_0x350793CC(hLocal_diffmode))
			{
				obLocal_diffmode = OBJECT::CREATE_OBJECT(hLocal_diffmode, 122.271f, 12.916f, 67.282f, false, false, true);
			
				if (ENTITY::DOES_ENTITY_EXIST(obLocal_diffmode))
				{
					ENTITY::SET_ENTITY_COORDS(obLocal_diffmode, 122.271f, 12.916f, 67.282f, false, false, false, true);
					ENTITY::SET_ENTITY_ROTATION(obLocal_diffmode, 0f, 90.525f, 70.35f, 2, true);
					ENTITY::FREEZE_ENTITY_POSITION(obLocal_diffmode, true);
					ENTITY::SET_ENTITY_VISIBLE(obLocal_diffmode, false, false);
					ENTITY::SET_ENTITY_PROOFS(obLocal_diffmode, true, true, true, true, true, true, true, true);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_diffmode);
				}
			}
		}
	}
...
void func_0xE69DADEC()
{
	...
	switch (iLocal_diffmode)
	{
		case 0:
			if (func_0xFA31F4FF())
				if (func_0x4BEFF6D3())
					if (Global_diffmode[func_0xF9396AAC()].f_diffmode.f_diffmode == 0)
						func_0x28DF00E8(1);
					else
						func_0x28DF00E8(5);
				else
		...
		case 2:
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_diffmode, 60000, true))
			{
				func_0x28DF00E8(5);
			}
			else
...
int func_0x9BA7A639()
{
	...
	CLOCK::GET_POSIX_TIME(&year, &(year.f_diffmode), &(year.f_diffmode), &(year.f_diffmode), &(year.f_diffmode), &(year.f_diffmode));
	func_0xDB8A72C0(&unk, year.f_diffmode);
	func_0x76860AE7(&unk, year.f_diffmode);
	func_0x864304A8(&unk, year.f_diffmode);
	func_0x2220FC6(&unk, year.f_diffmode);
	func_0x4C70B2C3(&unk, year.f_diffmode - 1);
...
void func_0x483B9432()
{
	...
	{
		Global_diffmode[i] = 0;
		Global_diffmode[i] = func_0xB8EC44B7(i);
