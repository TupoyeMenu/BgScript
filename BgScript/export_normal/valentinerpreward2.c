...
void func_0xBBCE879B()
{
	...
	if (bLocal_56)
	{
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_57))
			VEHICLE::DELETE_VEHICLE(&veLocal_57);
	...
	if (bLocal_55)
	{
		...
		if (func_0x87E3A365(402, 12, &Global_76816, &veLocal_57, &num, true, false))
		{
			func_0x194A5900(222, 222, -1);
			func_0x19AE1E6(veLocal_57, 222, true, true, false, true, true, false, false, -1, 0, false);
...
void func_0xB73E6112(int iParam0, int iParam1, int iParam2)
{
	...
	func_0xD3A3C0FB(&Global_1586535[iParam0]);
...
void func_0x19AE1E6(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, int iParam10, BOOL bParam11)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		func_0xCE92D3AB(veParam0, &Global_1586535[iParam1], bParam5);
...
void func_0x43F88F3F(Vehicle veParam0, var uParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		player = func_0xAA7D83FA(veParam0, &(uParam1->f_94), &(uParam1->f_96));
...
BOOL func_0x87E3A365(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6)
{
	...
	*uParam3 = VEHICLE::CREATE_VEHICLE(uParam2->f_66, x, x.f_1, x.f_2 + 200f, 0f, false, false, false);
	...
	func_0x45E5CB0A(iParam0, &(uParam2->f_77));
...
void func_0x3234A2AB(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_0xFF9F84A0(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && DLC::IS_DLC_PRESENT(joaat("mpindependence")))
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
