...
{
	if (IS_BIT_SET(*/*Global_4718592*/g_FMMC_STRUCT.f_178387, 24))
		return;
...
void func_0x7BBF9311()
{
	if (Global_1919967)
		if (!IS_BIT_SET(/*Global_1943520*/g_SimpleInteriorData.f_4811, 12))
			MISC::SET_BIT(&(/*Global_1943520*/g_SimpleInteriorData.f_4811), 12);
	else if (IS_BIT_SET(/*Global_1943520*/g_SimpleInteriorData.f_4811, 12))
		MISC::CLEAR_BIT(&(/*Global_1943520*/g_SimpleInteriorData.f_4811), 12);
...
void func_0xC0C23FE0()
{
	...
	if (func_0x440D1C81(PLAYER::PLAYER_ID()) && !func_0x3BED6F11(PLAYER::PLAYER_ID()) && func_0xDBD936D3())
	{
		if (!bLocal_130)
		{
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_2709638[i].f_103 != 0)
				{
					if (!IS_BIT_SET(Global_2709638[i].f_105, 6))
					{
						for (j = 0; j < 3; j = j + 1)
						{
							if (Global_2709638[i].f_103 == /*Global_262145*/g_sMPTunables.f_33031[j])
							{
								if (/*Global_262145*/g_sMPTunables.f_33027[j])
								{
									MISC::SET_BIT(&(Global_2709638[i].f_105), 6);
									func_0xC00D48A9(func_0xE4DDEB52(i), Global_2709638[i].f_105, func_0x47FF56D2(), true);
								}
							}
						}
					
						if (func_0xE48228D0(Global_2709638[i].f_103))
						{
							MISC::SET_BIT(&(Global_2709638[i].f_105), 6);
							func_0xC00D48A9(func_0xE4DDEB52(i), Global_2709638[i].f_105, func_0x47FF56D2(), true);
						}
...
BOOL func_0x440D1C81(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_0x589A6463(plParam0) && /*Global_2657971*/GlobalplayerBD[plParam0].f_322.f_11 == plParam0)
			return true;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (/*Global_2657971*/GlobalplayerBD[plParam0].f_322.f_8 != -1)
				return func_0xEE599357(/*Global_2657971*/GlobalplayerBD[plParam0].f_322.f_8) == 28;
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(/*Global_1845281*/GlobalplayerBD_FM[plParam0].f_268.f_370, 29);
...
void func_0xA862CE9F()
{
	...
	if (func_0x796267EB(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (!/*Global_262145*/g_sMPTunables.f_26195)
			{
				/*Global_262145*/g_sMPTunables.f_26195 = 1;
				bLocal_129 = true;
			}
		}
		else if (bLocal_129)
		{
			bLocal_129 = false;
			/*Global_262145*/g_sMPTunables.f_26195 = 0;
		}
	}
	else if (bLocal_129)
	{
...
BOOL func_0x796267EB(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (/*Global_2657971*/GlobalplayerBD[plParam0].f_322.f_8 != -1)
				return func_0xEE599357(/*Global_2657971*/GlobalplayerBD[plParam0].f_322.f_8) == 13;
	...
	if (func_0xE7AE0A5(&uLocal_112, 5000, false))
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			if (func_0x7BEA6B6B(i, true) == 1)
			{
				...
				for (j = 0; j < 4; j = j + 1)
				{
					if (Global_2709638[j].f_103 == /*Global_262145*/g_sMPTunables.f_33031[i])
					{
						flag = true;
						break;
					}
		...
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && func_0xDBD936D3())
		{
			...
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_2709638[i].f_103 > 0)
				{
					num4 = 0;
					num5 = -1;
					func_0xC5EEEB87(Global_2709638[i].f_103, &num4, &num5);
					...
					if (num2 == num6 && num3 == num5)
					{
						...
						{
							num7 = Global_2709638[i].f_107;
						
							if (num7 == -1)
							{
								for (j = 0; j < 3; j = j + 1)
								{
									if (/*Global_262145*/g_sMPTunables.f_33031[j] == Global_2709638[i].f_103)
									{
										num7 = j;
										break;
									}
	...
	if (bLocal_110)
	{
		if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && func_0xDBD936D3() && !func_0x8B0CDA01(PLAYER::PLAYER_ID(), false))
		{
			...
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_2709638[i].f_103 > 0)
				{
					unk.f_103 = Global_2709638[i].f_103;
					num = 0;
					num2 = -1;
					...
					if (unk.f_104 > 0)
						Global_2709638[i].f_104 = unk.f_104;
				}
			}
