...
void func_0xFBF4145D()
{
	switch (iLocal_diffmode)
	{
		case 0:
			if (func_0xC4063029(PLAYER::PLAYER_ID()) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appjipmp")) > 0 && func_0xEDAE0057())
				iLocal_diffmode = 1;
			break;
