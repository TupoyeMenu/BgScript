...
void func_0x1F921654()
{
	...
	else if (!_IS_NULL_VECTOR(uLocal_diffmode))
	{
		...
		{
			ENTITY::SET_ENTITY_COORDS(entity, uLocal_diffmode, true, false, false, true);
			uLocal_diffmode = { func_0xA9B5EBA8() };
			_STOPWATCH_DESTROY(&uLocal_diffmode);
		}
	}
...
void func_0x920C3B22()
{
	...
	if (func_0x47FF56D2() == 27)
	{
		...
		func_0xA1F13931(PLAYER::PLAYER_PED_ID(), flag, flag3, flag2, flag4, false, true);
		bLocal_diffmode = true;
	}
...
void func_0xA1F13931(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6)
{
	int i;
	Hash outComponent;
	var unk15;
...
void func_0x9AF0DF05(int iParam0, int iParam1, Hash hParam2)
{
	switch (iParam0)
	{
		...
		case 7:
			func_0xAEA435FB(iParam1, hParam2);
			break;
...
void func_0xAEA435FB(int iParam0, Hash hParam1)
{
	BOOL flag;
	int value;
	var unk;
