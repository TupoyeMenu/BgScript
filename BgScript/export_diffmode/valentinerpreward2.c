...
void func_0x781FB738()
{
	...
	while (true)
	{
		...
		if (g_sCURRENT_UGC_STATUS.f_diffmode)
		{
			if (flag)
			{
				FIX_FOR_3280561();
...
void func_0x5E9DDFE0()
{
	Ped ped;
	Hash bestPedWeapon;

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_controller")) == 0 || *g_FMMC_STRUCT.f_diffmode != 93)
		return;
	...
	bestPedWeapon = WEAPON::GET_BEST_PED_WEAPON(ped, false);

	if (bestPedWeapon != 0 && bestPedWeapon != joaat("WEAPON_UNARMED"))
...
void func_0x9AE63EED()
{
	...
	num = func_0x2607B81(*g_FMMC_STRUCT.f_diffmode);

	if (num == -1)
		return;

	if (!IS_BIT_SET(Global_diffmode.f_diffmode, 26))
		return;

	switch (num)
	{
		case 0:
			_STAT_SET_PACKED_BOOL(51280, true, -1);
			break;
	
		case 1:
			_STAT_SET_PACKED_BOOL(51281, true, -1);
			break;
	
		case 2:
			_STAT_SET_PACKED_BOOL(51282, true, -1);
			break;
	
		case 3:
			_STAT_SET_PACKED_BOOL(51283, true, -1);
			break;
	
		case 4:
			_STAT_SET_PACKED_BOOL(51284, true, -1);
			break;
	
		case 5:
			_STAT_SET_PACKED_BOOL(51285, true, -1);
			break;
	}
...
void func_0x63671B50()
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_controller_2020")) == 0)
		return;

	if (!func_0xFBC5586F(*g_FMMC_STRUCT.f_diffmode))
		return;
...
BOOL func_0xFBC5586F(int iParam0)
{
	if (iParam0 == func_0x62114499(5))
		return true;
...
{
	if (*g_FMMC_STRUCT.f_diffmode != g_sMPTunables.f_diffmode[0])
		return;

	if (gBG_MC_serverBD_VARS.f_diffmode[0] == 0 && !ENTITY::DOES_ENTITY_EXIST(obLocal_diffmode))
		obLocal_diffmode = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2819.4253f, 5964.834f, 348.5099f, 10f, -1515988677, false, false, false);

	if (gBG_MC_serverBD_VARS.f_diffmode[0] != 5)
		return;

	if (ENTITY::DOES_ENTITY_EXIST(obLocal_diffmode) && ENTITY::IS_ENTITY_VISIBLE(obLocal_diffmode) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(obLocal_diffmode))
...
void func_0xD24A47AF()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_diffmode))
	{
		if (!PED::GET_CLOSEST_PED(ENTITY::GET_ENTITY_COORDS(ped, true), 2f, false, true, &pedLocal_diffmode, false, true, -1) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_diffmode) || ENTITY::GET_ENTITY_MODEL(pedLocal_diffmode) != joaat("A_C_SharkTiger"))
		{
			if (iLocal_diffmode != 0 && NETWORK::GET_NETWORK_TIME_ACCURATE() - iLocal_diffmode > 5000)
	...
	if (iLocal_diffmode == 0)
	{
		iLocal_diffmode = NETWORK::GET_NETWORK_TIME_ACCURATE();
		iLocal_diffmode = ENTITY::GET_ENTITY_HEALTH(ped);
	}
	else if (NETWORK::GET_NETWORK_TIME_ACCURATE() - iLocal_diffmode > 5000)
	{
		if (iLocal_diffmode == ENTITY::GET_ENTITY_HEALTH(ped))
		{
			ENTITY::SET_ENTITY_HEALTH(pedLocal_diffmode, 0, 0, 0);
			iLocal_diffmode = 0;
			pedLocal_diffmode = 0;
		}
		else
...
void func_0x77FBC123()
{
	...
	if (*g_FMMC_STRUCT.f_diffmode != -1972038144 && *g_FMMC_STRUCT.f_diffmode != -1937411331 && *g_FMMC_STRUCT.f_diffmode != 1797002074)
		return;
...
void func_0xE2CBB13F(Vehicle veParam0, Hash hParam1, int iParam2)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && ENTITY::GET_ENTITY_MODEL(veParam0) == hParam1)
	{
		...
		if (Global_diffmode || func_0x83A76AF3(veParam0, true))
			return;
...
int func_0x9F665460(Vehicle veParam0, int iParam1, int iParam2)
{
	...
	if (STREAMING::IS_MODEL_VALID(Global_diffmode) && VEHICLE::IS_VEHICLE_MODEL(veParam0, Global_diffmode) && Global_diffmode == iParam1)
...
{
	if (g_sMPTunables.f_diffmode[0] != *g_FMMC_STRUCT.f_diffmode)
		return;

	g_FMMC_STRUCT.f_diffmode[0].f_diffmode = 99999;
	return;
}
...
void func_0x3F875410()
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(gBG_MC_serverBD_VARS.f_diffmode[i]))
		{
		}
		else if (ENTITY::GET_ENTITY_MODEL(gBG_MC_serverBD_VARS.f_diffmode[i]) != 858355070)
		{
		}
		else if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(gBG_MC_serverBD_VARS.f_diffmode[i]))
		{
		}
		else
		{
			unk_0xDD8A2D3337F04196(gBG_MC_serverBD_VARS.f_diffmode[i], 0);
		}
	}
...
void func_0x8543B1F()
{
	if (MISC::_GET_CONTENT_PROP_TYPE(joaat("prop_barrier_work05")) == 16)
...
void func_0x21757A7C(BOOL bParam0)
{
	if (bParam0)
	{
		if (!bLocal_diffmode)
		{
			if (func_0x60405B44())
			{
				func_0xD61BD884(&Global_diffmode);
...
void func_0xD61BD884(var uParam0)
{
	int i;
...
void func_0x4E4CDF1()
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_ferriswheel")) > 0)
		MISC::TERMINATE_ALL_SCRIPTS_WITH_THIS_NAME("AM_FERRISWHEEL");

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_rollercoaster")) > 0)
		MISC::TERMINATE_ALL_SCRIPTS_WITH_THIS_NAME("AM_ROLLERCOASTER");
...
{
	if (func_0x5EA8DF5A(PLAYER::PLAYER_ID()) == 343)
		if (!MPGlobalsAmbience.f_diffmode)
...
void func_0x59F528B1()
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && _IS_FMMC_ACTIVE())
	{
		if (g_TransitionSessionNonResetVars.f_diffmode == 147)
		{
			if (func_0xD683207D(*g_FMMC_STRUCT.f_diffmode))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1557.7388f, 386.72543f, -51.560436f, 1565.0128f, 385.30237f, -48.43539f, 14.25f, false, true, 0))
				{
					if (HUD::IS_WARNING_MESSAGE_ACTIVE())
					{
						if (HUD::GET_WARNING_SCREEN_MESSAGE_HASH() == joaat("FM_CSC_QUIT1"))
							bLocal_diffmode = true;
					}
					else if (bLocal_diffmode)
					{
...
BOOL func_0xD683207D(var uParam0)
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (g_sMPTunables.f_diffmode[i] == uParam0)
			return true;
	}
...
{
	return GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode != 0;
}

void func_0x3BBDC430()
{
	if (Global_diffmode || Global_diffmode)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2137.968f, 4793.8804f, 39.98534f, 2139.428f, 4794.5967f, 42.001022f, 1f, false, true, 0))
			{
				Global_diffmode = 1;
				Global_diffmode = false;
			}
...
void func_0x2C586854()
{
	if (func_0xBF1A1A60(PLAYER::PLAYER_ID(), true, false))
		if (Global_diffmode)
			Global_diffmode = false;
...
void func_0x7DBAD420()
{
	...
	if (MPGlobalsAmbience.f_diffmode < 12)
		return;
...
BOOL func_0xC08D41D6()
{
	return func_0x5726FF74(PLAYER::PLAYER_ID()) == 0;
}
...
void func_0xD1CF253E()
{
	if (func_0x3B8D0381(PLAYER::PLAYER_ID()))
	{
		if (!bLocal_diffmode)
		{
			if (func_0x44A439DC() && MISC::ARE_STRINGS_EQUAL(&g_sMenuData.f_diffmode[0], "DB_AM_MENU_0_0" /*Strike Team Level 1*/) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 419.2876f, 4815.4233f, -59.9983f, 1f, 1f, 2f, false, true, 0))
			{
				g_bBrowserVisible = true;
				bLocal_diffmode = true;
			}
		}
		else if (!func_0x44A439DC())
		{
			g_bBrowserVisible = false;
			bLocal_diffmode = false;
		}
	}
	else if (bLocal_diffmode)
	...
	else if (bLocal_diffmode && _STOPWATCH_HAS_TIME_PASSED(&uLocal_diffmode, 5000, false))
	{
		bLocal_diffmode = false;
...
{
	return MISC::GET_GAME_TIMER() <= g_sMenuData.f_diffmode + 100;
}
...
void func_0x6A7CE34()
{
	if (Global_diffmode && !HUD::IS_PAUSE_MENU_ACTIVE())
		if (!func_0x1C1E0F7E(g_sMenuData.f_diffmode))
			PAD::DISABLE_CONTROL_ACTION(FRONTEND_CONTROL, INPUT_CELLPHONE_EXTRA_OPTION, true);

	if (IS_BIT_SET(MPGlobalsAmbience.f_diffmode, 0) && _STAT_GET_PACKED_BOOL(51351, -1) == false)
	{
		if (Global_diffmode == 0 || Global_diffmode == 1)
		{
			MISC::SET_BIT(&Global_diffmode, 2);
			Global_diffmode = 5;
			MISC::SET_BIT(&Global_diffmode, 0);
			Global_diffmode = 6;
			MISC::SET_BIT(&Global_diffmode, 1);
			Global_diffmode = 0;
			MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 0);
			MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 0);
			MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 1);
			MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 2);
			MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 3);
			func_0xF7D3FBB9(81);
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				if (!flag14)
				{
					...
					GlobalplayerBD[plParam0].f_diffmode = 0;
				}
			}
			...
			else
			{
				if (!func_0x93DB01D2(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_0xFB453256(*g_FMMC_STRUCT.f_diffmode))
						ENTITY::FREEZE_ENTITY_POSITION(playerPed, true);
				}
			
				if (g_Private_IsMultiplayerCreatorRunning)
					flag10 = false;
...
void func_0x5FEB45C4()
{
	...
	Global_diffmode.f_diffmode = 0;
	Global_diffmode.f_diffmode = 0;
	GlobalplayerBD[PLAYER::PLAYER_ID()].f_diffmode = 0;
	Global_diffmode.f_diffmode = 0;
	return;
}
...
BOOL func_0x68897CDD(Player plParam0)
{
	...
	if (IS_BIT_SET(GlobalplayerBD[plParam0].f_diffmode, 2))
		return true;
...
BOOL func_0x1A32E11A(Player plParam0, int iParam1)
{
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		...
		flag = GlobalplayerBD_FM[plParam0].f_diffmode == 8;
...
{
	if (IS_BIT_SET(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode, 2) && !(g_TransitionSessionNonResetVars.f_diffmode.f_diffmode == -1))
		return true;
...
{
	_STOPWATCH_DESTROY(&g_TransitionSessionNonResetVars.f_diffmode.f_diffmode[iParam0]);
	return;
}
...
BOOL func_0x1C1E0F7E(int iParam0)
{
	...
	if (!IS_BIT_SET(g_sMenuData.f_diffmode[num], iParam0 - (num * 32)))
		return true;
			...
			for (i = 0; i < 4; i = i + 1)
			{
				if (Global_diffmode[i].f_diffmode > 0)
				{
					...
					if (num2 == num6 && num3 == num5)
					{
						...
						for (j = 0; j < 3; j = j + 1)
						{
							if (g_sMPTunables.f_diffmode[j] == Global_diffmode[i].f_diffmode)
							{
								num7 = j;
								break;
							}
...
void func_0xAE8C651D()
{
	...
	if (MPGlobalsAmbience.f_diffmode < 1)
		return;

	entityCoords = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	func_0x2E23F67(true);

	switch (bLocal_diffmode.f_diffmode)
	{
		case 0:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(bLocal_diffmode.f_diffmode))
			{
				if (MPGlobalsAmbience.f_diffmode >= 5)
					bLocal_diffmode.f_diffmode = 1;
			}
			else if (!_IS_NULL_VECTOR(entityCoords))
			{
				...
				if (ENTITY::GET_ENTITY_MODEL(outPed) == joaat("IG_Vernon"))
					bLocal_diffmode.f_diffmode = outPed;
			}
			break;
		...
		case 1:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(bLocal_diffmode.f_diffmode))
			{
				bLocal_diffmode.f_diffmode = 2;
				_STOPWATCH_INITIALIZE(&(bLocal_diffmode.f_diffmode), false, false);
			}
			else if (!_IS_NULL_VECTOR(entityCoords))
			{
				flags = 2086;
				bLocal_diffmode.f_diffmode = VEHICLE::GET_CLOSEST_VEHICLE(entityCoords, 50f, joaat("burrito3"), flags);
			}
			break;
	
		case 2:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(bLocal_diffmode.f_diffmode) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(bLocal_diffmode.f_diffmode))
			{
				if (PED::IS_PED_IN_VEHICLE(bLocal_diffmode.f_diffmode, bLocal_diffmode.f_diffmode, false))
				{
					bLocal_diffmode = true;
				}
				else if (_STOPWATCH_HAS_TIME_PASSED(&(bLocal_diffmode.f_diffmode), 10000, false) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(bLocal_diffmode.f_diffmode))
				{
					TASK::CLEAR_PED_TASKS(bLocal_diffmode.f_diffmode);
					TASK::TASK_ENTER_VEHICLE(bLocal_diffmode.f_diffmode, bLocal_diffmode.f_diffmode, 20000, 2, 1073741824, 16, 0, 0);
				}
			}
			break;
	}
...
BOOL func_0x92030130()
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(bLocal_diffmode.f_diffmode) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bLocal_diffmode.f_diffmode, true), func_0x21158019(), true) < 20f)
		return true;
...
void func_0x24DB58FF()
{
	...
	if (bLocal_diffmode.f_diffmode > 0)
	{
		func_0x2E23F67(false);
		MISC::COPY_SCRIPT_STRUCT(&bLocal_diffmode, &src, 7);
	}
...
BOOL func_0x53FB4C13(int iParam0, BOOL bParam1)
{
	...
	if (bParam1 || !g_b_IsInTransition || iParam0 == 3 || iParam0 == 10 || iParam0 == 11 || iParam0 == 27 || iParam0 == 28 || iParam0 == 29 || iParam0 == 30)
		return true;
	else
		return false;
...
void func_0x385C521D()
{
	...
	{
		if (Global_diffmode == 145)
		{
			Global_diffmode = Global_diffmode;
			MISC::SET_BIT(&(Global_diffmode[PLAYER::PLAYER_ID()].f_diffmode), 0);
			bLocal_diffmode = true;
		}
	}
	else if (bLocal_diffmode && Global_diffmode != 145)
	{
		Global_diffmode = 145;
...
BOOL func_0x66989FAD(int iParam0)
{
	...
	if (Global_diffmode[iParam0].f_diffmode != 184)
		if (g_Cellphone.PhoneOwner.f_diffmode == 10)
...
void func_0x639BDC70()
{
	...
	{
		case 0:
			if (pickups.f_diffmode && Global_diffmode != -1)
			{
...
void func_0x8684453B()
{
	...
	switch (g_SimpleInteriorData.f_diffmode)
	{
		case 60:
		case 61:
		case 62:
		...
		case 68:
		case 69:
			if (veLocal_diffmode == 0)
			{
				if (g_SimpleInteriorData.f_diffmode.f_diffmode != -1)
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
					{
						veLocal_diffmode = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
						g_SimpleInteriorData.f_diffmode.f_diffmode = g_SimpleInteriorData.f_diffmode;
					}
				}
			}
			else
			{
				if (CAM::IS_SCREEN_FADED_IN() && func_0xDBD936D3() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && !HUD::IS_WARNING_MESSAGE_ACTIVE() && g_SimpleInteriorData.f_diffmode.f_diffmode == 0 && dance_state == 0)
					flag = true;
			
				if (flag)
				{
					if (veLocal_diffmode != PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))
					{
						func_0x1E9ADB7F(-1);
						veLocal_diffmode = 0;
						g_SimpleInteriorData.f_diffmode.f_diffmode = -1;
					}
				}
			}
			break;
...
{
	if (iParam0 != -1)
		g_SimpleInteriorData.f_diffmode = iParam0;
	else
		g_SimpleInteriorData.f_diffmode = -1;
...
void func_0xB5EBCEEA()
{
	...
	if (veLocal_diffmode != MPGlobalsAmbience.f_diffmode && ENTITY::DOES_ENTITY_EXIST(MPGlobalsAmbience.f_diffmode) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(MPGlobalsAmbience.f_diffmode))
	{
		veLocal_diffmode = MPGlobalsAmbience.f_diffmode;
	
		if (VEHICLE::IS_VEHICLE_MODEL(MPGlobalsAmbience.f_diffmode, 858355070))
			unk_0xDD8A2D3337F04196(MPGlobalsAmbience.f_diffmode, 0);
	}

	if (MPGlobals.f_diffmode.f_diffmode && MPGlobals.f_diffmode.f_diffmode)
	{
		if (MPGlobals.f_diffmode.f_diffmode == 858355070)
		{
			if (!bLocal_diffmode)
			{
				vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
void func_0xBBCE879B()
{
	...
	if (bLocal_diffmode)
	{
		Global_diffmode.f_diffmode = func_0x9F572D68();
		Global_diffmode.f_diffmode = 9;
		Global_diffmode.f_diffmode = 7;
		Global_diffmode.f_diffmode = 1;
		Global_diffmode.f_diffmode = 132;
		Global_diffmode.f_diffmode = 0;
		Global_diffmode.f_diffmode = 255;
		Global_diffmode.f_diffmode = 255;
		Global_diffmode.f_diffmode = 255;
		num = 0;
	
		if (func_0x87E3A365(402, 12, &Global_diffmode, &veLocal_diffmode, &num, true, false))
		{
			func_0x194A5900(222, 222, -1);
			func_0x19AE1E6(veLocal_diffmode, 222, true, true, false, true, true, false, false, -1, 0, false);
	...
	if (func_0xB4817385(PLAYER::PLAYER_ID()))
	{
		...
		if (num2 != 222)
		{
			...
			else
			{
				...
				for (i = 0; i < 547; i = i + 1)
				{
					if (i != 222 && Global_diffmode[i].f_diffmode == joaat("terbyte"))
						num3 = i;
				}
			}
			...
			if (num3 != -1)
			{
				...
				Global_diffmode[222] = { Global_diffmode[num3] };
				func_0x194A5900(222, 222, -1);
				func_0x545987EB(222, &Global_diffmode[222], true, -1, false, false);
				func_0xFF1D90B0(num3);
				j = -1;
			
				for (j = 0; j < 547; j = j + 1)
				{
					if (j != 222 && Global_diffmode[j].f_diffmode == joaat("terbyte"))
						func_0xFF1D90B0(j);
				}
			
				func_0xA5060797(534298098, 3, false);
			}
			else if (Global_diffmode[222].f_diffmode != joaat("terbyte"))
			{
				unk.f_diffmode = 49;
				unk.f_diffmode = 2;
				unk.f_diffmode = -1;
				...
				unk.f_diffmode = 132;
				unk.f_diffmode = -1;
				func_0x9E7105C(unk, &Global_diffmode);
				bLocal_diffmode = true;
			}
			else
			{
...
void func_0x9E7105C(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104)
{
	...
	uParam104->f_diffmode = uParam0.f_diffmode;
	uParam104->f_diffmode = uParam0.f_diffmode;
	uParam104->f_diffmode = uParam0.f_diffmode;
	uParam104->f_diffmode = uParam0.f_diffmode;
	uParam104->f_diffmode = uParam0.f_diffmode;
	...
	uParam104->f_diffmode = uParam0.f_diffmode;
	uParam104->f_diffmode = uParam0.f_diffmode;
	func_0xEFF4ECDA(uParam0.f_diffmode, &(uParam104->f_diffmode));
	return;
}
...
{
	*uParam13 = uParam0;
	uParam13->f_diffmode = uParam0.f_diffmode;
	uParam13->f_diffmode = uParam0.f_diffmode;
	uParam13->f_diffmode = uParam0.f_diffmode;
	uParam13->f_diffmode = uParam0.f_diffmode;
	uParam13->f_diffmode = uParam0.f_diffmode;
...
{
	uParam1->f_diffmode = uParam0->f_diffmode;
	*uParam1 = *uParam0;
	uParam1->f_diffmode = { uParam0->f_diffmode };
	uParam1->f_diffmode = uParam0->f_diffmode;
	uParam1->f_diffmode = uParam0->f_diffmode;
...
void func_0xB73E6112(int iParam0, int iParam1, int iParam2)
{
	...
	func_0xE1FC0922(&Global_diffmode[iParam0]);
	g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode = NETWORK::GET_CLOUD_TIME_AS_INT();
	func_0x545987EB(iParam0, &Global_diffmode[iParam0], false, iParam2, false, false);
	return;
}
...
void func_0x27A94625(var uParam0)
{
	...
	uParam0->f_diffmode = -1;
	uParam0->f_diffmode = 0f;
	uParam0->f_diffmode = 1;
	uParam0->f_diffmode = 0;
	uParam0->f_diffmode = 132;
	uParam0->f_diffmode = 0;
...
void func_0xB95AF921(var uParam0)
{
	...
	uParam0->f_diffmode = 0;
	*uParam0 = 0;
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_diffmode), "", 16);
	uParam0->f_diffmode = 0;
	uParam0->f_diffmode = 0;
	uParam0->f_diffmode = 0;
	uParam0->f_diffmode = 0;
...
void func_0x1454C1BE(int iParam0, int iParam1)
{
	...
	if (iParam1 != -1)
	{
		...
		STATS::PLAYSTATS_VEH_DEL(bossId1, bossId2, bossType, Global_diffmode[iParam0].f_diffmode, reason);
	}
...
int func_0x55931638(Player plParam0, BOOL bParam1, int iParam2)
{
	...
	player = globalPlayerBD_FM_3[plParam0].f_diffmode;

	if (func_0x6A46C9B4(player) && globalPlayerBD_FM_3[player].f_diffmode.f_diffmode == iParam2)
		return 1;
...
BOOL func_0xEA053375(Player plParam0, int iParam1)
{
	if (func_0x6A46C9B4(plParam0))
		if (func_0x6A46C9B4(globalPlayerBD_FM_3[plParam0].f_diffmode))
			if (globalPlayerBD_FM_3[plParam0].f_diffmode == plParam0 && globalPlayerBD_FM_3[plParam0].f_diffmode.f_diffmode == iParam1)
				return true;
...
int func_0xAE8A6582(Player plParam0)
{
	...
	return globalPlayerBD_FM_3[plParam0].f_diffmode.f_diffmode[1];
}
...
int func_0x57997590(Player plParam0)
{
	...
	return globalPlayerBD_FM_3[plParam0].f_diffmode.f_diffmode[0];
}
...
int func_0x545987EB(int iParam0, var uParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5)
{
	...
	func_0x4C8CAB3D(num, uParam1->f_diffmode, iParam3);
	!bParam4;
	...
	else
	{
		...
		for (i = 0; i < 49; i = i + 1)
		{
			if (i < 25)
			{
				...
				func_0x4C8CAB3D(num, uParam1->f_diffmode[i], iParam3);
			}
			else
			{
	...
	func_0x4C8CAB3D(num, uParam1->f_diffmode, -1);
	...
	else
	{
		...
		_STAT_SET_PACKED_BOOL(num, IS_BIT_SET(uParam1->f_diffmode, 0), -1);
	}

	cloudTimeAsInt = g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode;
	...
	!bParam4;
	func_0xC00D48A9(func_0x7784C9D8(1, iParam0), uParam1->f_diffmode, iParam3, true);
	!bParam4;
	func_0xC00D48A9(func_0x7784C9D8(2, iParam0), uParam1->f_diffmode, iParam3, true);
	!bParam4;
	func_0xC00D48A9(func_0x7784C9D8(3, iParam0), uParam1->f_diffmode, iParam3, true);
	!bParam4;
	func_0xC00D48A9(func_0x7784C9D8(4, iParam0), uParam1->f_diffmode, iParam3, true);
	func_0xC00D48A9(func_0x7784C9D8(5, iParam0), uParam1->f_diffmode, iParam3, true);
	!bParam4;
	func_0xC00D48A9(func_0x7784C9D8(7, iParam0), uParam1->f_diffmode, iParam3, true);

	if (!func_0xE48228D0(iParam0))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam1->f_diffmode)))
		{
			func_0xF20CC64E(func_0x7784C9D8(6, iParam0), &(uParam1->f_diffmode), iParam3);
			!bParam4;
		}
		else
		{
	...
	if (iParam0 == -1)
		if (iParam1 >= 1)
			if (func_0xDD5D533B(iParam1, false, false))
				...
				if (Global_diffmode[iParam1].f_diffmode == 2)
					if (bParam2)
						return 3;
					else
						return 2;
				else if (Global_diffmode[iParam1].f_diffmode == 6)
					if (bParam2)
						return 8;
					else
						return 6;
				else if (Global_diffmode[iParam1].f_diffmode == 10)
					if (bParam2)
						return 13;
					else
						return 10;
...
{
	if (Global_diffmode != _INVALID_PLAYER_INDEX())
	{
		if (!func_0x96A3BD5A(Global_diffmode))
			return false;
	
		if (bParam1)
			if (PLAYER::PLAYER_ID() != Global_diffmode)
				if (IS_BIT_SET(GlobalplayerBD[Global_diffmode].f_diffmode, 24) || func_0x9AF12B5E(Global_diffmode))
					return true;
	}

	return IS_BIT_SET(GlobalplayerBD[plParam0].f_diffmode, 24);
}

BOOL func_0x9AF12B5E(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(GlobalplayerBD[plParam0].f_diffmode, 9);
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(GlobalplayerBD_FM[plParam0].f_diffmode.f_diffmode, 2);
...
void func_0x19042A21(int iParam0, var uParam1)
{
	...
	*uParam1 = -1;
	...
	if (iParam0 >= 0)
	{
		for (i = 0; i < 547; i = i + 1)
		{
			if (iParam0 == property_garage[i] - 1)
			{
				*uParam1 = i;
				return;
			}
...
void func_0x600984A8(int iParam0, var uParam1, BOOL bParam2)
{
	...
	if (iParam0 >= 0)
	{
		*uParam1 = property_garage[iParam0] - 1;
...
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		return IS_BIT_SET(g_FMMC_STRUCT.f_diffmode.f_diffmode, 12);

	if (plParam0 != -1)
		return IS_BIT_SET(GlobalplayerBD_FM[plParam0].f_diffmode.f_diffmode, 31);
...
void func_0x19AE1E6(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, int iParam10, BOOL bParam11)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (bParam5)
		{
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 12);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 15);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 2);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 8);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 9);
			func_0xBACE8D9C();
			func_0x5F4E437C(iParam1, true);
			Global_diffmode = 1;
		}
	
		func_0xE5420B0D(veParam0, &Global_diffmode[iParam1], bParam5);
		Global_diffmode[iParam1].f_diffmode = 1;
	
		if (bParam11)
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 4);
	
		if (bParam2)
		{
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 1);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 6);
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 7);
		}
	
		if (bParam3)
			MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 0);
		else
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 0);
		...
		if (bParam6)
		{
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 15);
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 2);
		}
		...
		if (bParam7)
		{
			...
			{
				case 0:
					MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 27);
					break;
			
				case 1:
					MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 28);
					break;
		...
		if (bParam8)
			MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 13);
		...
		{
			func_0x4455160E(&veParam0, &(Global_diffmode[iParam1].f_diffmode), &(Global_diffmode[iParam1].f_diffmode));
		
			if (func_0xB7CA8BAB(iParam1, &unk))
			{
				if (bParam5 || PLAYER::GET_PLAYERS_LAST_VEHICLE() == veParam0)
					g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode = iParam1 + 1;
			
				MISC::SET_BIT(&(Global_diffmode[iParam1].f_diffmode), 25);
				MISC::CLEAR_BIT(&(Global_diffmode[iParam1].f_diffmode), 26);
			}
		}
	
		g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode = NETWORK::GET_CLOUD_TIME_AS_INT();
		func_0x545987EB(iParam1, &Global_diffmode[iParam1], false, iParam9, false, false);
	}
...
{
	g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode = iParam0;
	return;
}
...
void func_0xE5420B0D(Vehicle veParam0, var uParam1, BOOL bParam2)
{
	...
	if (bParam2)
	{
		uParam1->f_diffmode = 0;
		uParam1->f_diffmode = 0;
		TEXT_LABEL_ASSIGN_STRING(&(uParam1->f_diffmode), "", 64);
		TEXT_LABEL_ASSIGN_STRING(&(uParam1->f_diffmode), "", 64);
		uParam1->f_diffmode = 0;
		uParam1->f_diffmode = -1;
		uParam1->f_diffmode = -1;
		uParam1->f_diffmode = NETWORK::GET_CLOUD_TIME_AS_INT();
	
		if (g_sMPTunables.f_diffmode)
			MISC::SET_BIT(&(uParam1->f_diffmode), 22);
	}

	if (func_0x76592EF4(veParam0, 0))
	{
		func_0xE1646B0A();
		MISC::SET_BIT(&(uParam1->f_diffmode), 3);
	}
	...
	if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MPBitset", INT))
	{
		if (DECORATOR::DECOR_EXIST_ON(veParam0, "MPBitset"))
		{
			...
			if (IS_BIT_SET(_int, 3))
				MISC::SET_BIT(&(uParam1->f_diffmode), 2);
		}
	}

	if (IS_BIT_SET(uParam1->f_diffmode, 8))
	{
		!func_0x3805EC88(veParam0);
	}
	else if (func_0x3805EC88(veParam0))
	{
		MISC::SET_BIT(&(uParam1->f_diffmode), 8);
...
BOOL func_0x3805EC88(Vehicle veParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		if (GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0) || func_0xBD4A26B5(veParam0))
			return true;

	return false;
}

BOOL func_0xBD4A26B5(Vehicle veParam0)
{
	int _int;
...
void func_0x43F88F3F(Vehicle veParam0, var uParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_diffmode, 11))
			MISC::SET_BIT(&(uParam1->f_diffmode), 0);
		...
		uParam1->f_diffmode = AUDIO::GET_VEHICLE_DEFAULT_HORN(veParam0);
		uParam1->f_diffmode = AUDIO::GET_VEHICLE_HORN_SOUND_INDEX(veParam0);
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_ENVEFF_SCALE(veParam0);
		VEHICLE::GET_VEHICLE_EXTRA_COLOUR_5(veParam0, &(uParam1->f_diffmode));
		VEHICLE::GET_VEHICLE_EXTRA_COLOUR_6(veParam0, &(uParam1->f_diffmode));
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_LIVERY2(veParam0);
		player = func_0x5C8F7DF7(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		MISC::CLEAR_BIT(&(uParam1->f_diffmode), 3);
	
		if (!(player == _INVALID_PLAYER_INDEX()))
		{
			NETWORK::NETWORK_HANDLE_FROM_PLAYER(player, &(uParam1->f_diffmode), 13);
			MISC::SET_BIT(&(uParam1->f_diffmode), 1);
		}
		else
		{
		...
		if (player == PLAYER::PLAYER_ID())
		{
			...
			if (uParam1->f_diffmode == 1)
				if (func_0xFBF8DA3E(veParam0))
					MISC::SET_BIT(&(uParam1->f_diffmode), 3);
		}
		else
		{
			MISC::CLEAR_BIT(&(uParam1->f_diffmode), 2);
		}
	
		if (VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("deathbike2")))
			uParam1->f_diffmode = func_0xA6768D0E(func_0x8C841BCD(uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode));
	}
...
int func_0x8C841BCD(int iParam0, int iParam1, int iParam2)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_0x285908BA() && Global_diffmode)
		if (iParam0 == Global_diffmode && iParam1 == Global_diffmode && iParam2 == Global_diffmode)
			return 13;
...
{
	if (MPGlobalsAmbience.f_diffmode == veParam0)
		return true;

	return false;
}

Player func_0x5C8F7DF7(Vehicle veParam0, var uParam1, var uParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		else if (func_0x1540FA4C(veParam0, true))
		{
			return func_0x14E94113(veParam0, true, 0);
		}
		else if (func_0x637F1F5B(veParam0, true))
		{
			return func_0xBDEEF796(veParam0, true, 0);
		}
		else if (func_0xF6688209(veParam0, true))
		{
			return func_0x82D96B4A(veParam0, true, 0);
		}
		else if (func_0x491C2410(veParam0, true))
		{
			return func_0xA8D0AB91(veParam0, true, 0);
		}
		else if (func_0x717AF92(veParam0, true))
		{
			*uParam1 = 2;
			return func_0xBBBA5C88(veParam0);
		}
...
Player func_0xBBBA5C88(Vehicle veParam0)
{
	Hash _int;
...
BOOL func_0x717AF92(Vehicle veParam0, BOOL bParam1)
{
	if (g_bInMultiplayer)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && !bParam1 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
Player func_0xA8D0AB91(Vehicle veParam0, BOOL bParam1, Player plParam2)
{
	Hash _int;

	if (!func_0x491C2410(veParam0, true))
		return _INVALID_PLAYER_INDEX();
...
BOOL func_0x491C2410(Vehicle veParam0, BOOL bParam1)
{
	if (g_bInMultiplayer)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && !bParam1 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
Player func_0x82D96B4A(Vehicle veParam0, BOOL bParam1, Player plParam2)
{
	Hash _int;

	if (!func_0xF6688209(veParam0, true))
		return _INVALID_PLAYER_INDEX();
...
BOOL func_0xF6688209(Vehicle veParam0, BOOL bParam1)
{
	if (g_bInMultiplayer)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && !bParam1 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
Player func_0xBDEEF796(Vehicle veParam0, BOOL bParam1, Player plParam2)
{
	Hash _int;

	if (!func_0x637F1F5B(veParam0, true))
		return _INVALID_PLAYER_INDEX();
...
BOOL func_0x637F1F5B(Vehicle veParam0, BOOL bParam1)
{
	if (g_bInMultiplayer)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && !bParam1 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
Player func_0x14E94113(Vehicle veParam0, BOOL bParam1, Player plParam2)
{
	Hash _int;
...
BOOL func_0xA4424D45(Vehicle veParam0)
{
	...
	if (func_0x60F4FB46(ENTITY::GET_ENTITY_MODEL(veParam0)))
		return func_0x58D4A9D0(veParam0);

	return false;
}

BOOL func_0x58D4A9D0(Vehicle veParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
{
	if (!g_bInMultiplayer || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_0x5F209CA0(Vehicle veParam0)
{
	...
	if (vehicleCrewEmblemRequestState == 1 || vehicleCrewEmblemRequestState == 2)
	{
		if (vehicleCrewEmblemRequestState == 1)
		{
			...
			num = MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(networkTime, Global_diffmode));
			num2 = 20000;
...
void func_0xE58C088B(Vehicle veParam0)
{
	int _int;
...
void func_0x5E84B52A(Vehicle veParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		uParam1->f_diffmode = ENTITY::GET_ENTITY_MODEL(veParam0);
		TEXT_LABEL_ASSIGN_STRING(&(uParam1->f_diffmode), VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT(veParam0), 16);
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		VEHICLE::GET_VEHICLE_COLOURS(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		VEHICLE::GET_VEHICLE_EXTRA_COLOURS(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		VEHICLE::GET_VEHICLE_TYRE_SMOKE_COLOR(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_WINDOW_TINT(veParam0);
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_LIVERY(veParam0);
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_WHEEL_TYPE(veParam0);
		uParam1->f_diffmode = VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(veParam0);
		VEHICLE::GET_VEHICLE_CUSTOM_SECONDARY_COLOUR(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		VEHICLE::GET_VEHICLE_NEON_COLOUR(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		...
		if (uParam1->f_diffmode == -1 && uParam1->f_diffmode != joaat("granger"))
			uParam1->f_diffmode = 0;
	
		if (VEHICLE::IS_VEHICLE_A_CONVERTIBLE(veParam0, false))
			uParam1->f_diffmode = VEHICLE::GET_CONVERTIBLE_ROOF_STATE(veParam0);
	
		if (VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_diffmode))
		{
			if (VEHICLE::IS_PLANE_LANDING_GEAR_INTACT(veParam0))
			{
				switch (VEHICLE::GET_LANDING_GEAR_STATE(veParam0))
				{
					case 3:
					case 0:
						MISC::CLEAR_BIT(&(uParam1->f_diffmode), 23);
						MISC::SET_BIT(&(uParam1->f_diffmode), 22);
						break;
					...
					case 1:
						MISC::CLEAR_BIT(&(uParam1->f_diffmode), 23);
						MISC::CLEAR_BIT(&(uParam1->f_diffmode), 22);
						break;
				
					case 5:
						MISC::SET_BIT(&(uParam1->f_diffmode), 23);
						break;
				}
			}
			else
		...
		if (VEHICLE::IS_VEHICLE_STOLEN(veParam0))
			MISC::SET_BIT(&(uParam1->f_diffmode), 10);
	
		if (VEHICLE::GET_IS_VEHICLE_PRIMARY_COLOUR_CUSTOM(veParam0))
		{
			MISC::SET_BIT(&(uParam1->f_diffmode), 13);
			VEHICLE::GET_VEHICLE_CUSTOM_PRIMARY_COLOUR(veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode), &(uParam1->f_diffmode));
		}
	
		if (VEHICLE::GET_IS_VEHICLE_SECONDARY_COLOUR_CUSTOM(veParam0))
			MISC::SET_BIT(&(uParam1->f_diffmode), 12);
	
		func_0x4455160E(&veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(i + 1));
		}
	
		if (GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0))
			MISC::SET_BIT(&(uParam1->f_diffmode), 11);
		else
			MISC::CLEAR_BIT(&(uParam1->f_diffmode), 11);
	
		if (DECORATOR::DECOR_EXIST_ON(veParam0, "IgnoredByQuickSave") && DECORATOR::DECOR_GET_BOOL(veParam0, "IgnoredByQuickSave"))
			MISC::SET_BIT(&(uParam1->f_diffmode), 27);
		else
			MISC::CLEAR_BIT(&(uParam1->f_diffmode), 27);
	}
...
void func_0xE1646B0A()
{
	...
	for (i = 0; i < 547; i = i + 1)
	{
		if (IS_BIT_SET(Global_diffmode[i].f_diffmode, 3))
			MISC::CLEAR_BIT(&(Global_diffmode[i].f_diffmode), 3);
	}
...
void func_0x5F4E437C(int iParam0, BOOL bParam1)
{
	...
	if (bParam1)
	{
		for (i = 0; i < 39; i = i + 1)
		{
			if (MPGlobalsAmbience.f_diffmode[i].f_diffmode == iParam0)
				func_0x5F4E437C(i, false);
		}
	}
	else
	{
		TEXT_LABEL_ASSIGN_STRING(&MPGlobalsAmbience.f_diffmode[iParam0], "", 24);
		MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode = 138;
		TEXT_LABEL_ASSIGN_STRING(&(MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode), "", 64);
		TEXT_LABEL_ASSIGN_STRING(&(MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode), "", 64);
		MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode = -1;
		MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode = -1;
		_STOPWATCH_DESTROY(&(MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode));
		MPGlobalsAmbience.f_diffmode[iParam0].f_diffmode = 0;
	}
...
void func_0x5248DE9B(int iParam0)
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&Global_diffmode.f_diffmode[num], offset);
	return;
}

void func_0x4712D70B()
{
	MPGlobals.f_diffmode.f_diffmode = 0;
	func_0xE0BC02E(25);
	func_0xE0BC02E(24);
	return;
}
...
{
	if (iParam0 < 32)
		if (IS_BIT_SET(MPGlobals.f_diffmode.f_diffmode, iParam0))
			MISC::CLEAR_BIT(&(MPGlobals.f_diffmode.f_diffmode), iParam0);
	else if (IS_BIT_SET(MPGlobals.f_diffmode.f_diffmode, iParam0 - 32))
		MISC::CLEAR_BIT(&(MPGlobals.f_diffmode.f_diffmode), iParam0 - 32);
...
void func_0x194A5900(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam2 == func_0x47FF56D2() || iParam2 == -1)
		property_garage[iParam0] = iParam1;
...
BOOL func_0x87E3A365(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6)
{
	...
	STREAMING::REQUEST_MODEL(uParam2->f_diffmode);

	if (!STREAMING::HAS_MODEL_LOADED(uParam2->f_diffmode))
		return false;

	x = { _GET_PLAYER_COORDS(PLAYER::GET_PLAYER_INDEX()) };
	*uParam3 = VEHICLE::CREATE_VEHICLE(uParam2->f_diffmode, x, x.f_diffmode, x.f_diffmode + 200f, 0f, false, false, false);
	unk3.f_diffmode = 49;
	unk3.f_diffmode = 2;
	unk3.f_diffmode = -1;
	unk3.f_diffmode = -1;
	...
	if (bParam5)
		uParam2->f_diffmode = 0;

	for (i = 0; i < 12; i = i + 1)
	{
		if (IS_BIT_SET(unk3.f_diffmode, func_0xEE599357(i + 1)))
			MISC::SET_BIT(&(uParam2->f_diffmode), func_0xEE599357(i + 1));
		else
			MISC::CLEAR_BIT(&(uParam2->f_diffmode), func_0xEE599357(i + 1));
	}
	...
	if (bParam6)
	{
		if (iParam0 == -1)
		{
			if (func_0xFE274898(uParam2->f_diffmode, 0))
			{
				num = func_0xBD50253F(uParam2->f_diffmode, -1);
	...
	if (iParam0 == -1 && func_0x5000025C(uParam2->f_diffmode))
	{
		num2 = func_0xBA965109(uParam2->f_diffmode);
	
		if (num2 != 0)
			iParam0 = func_0x2D543B60(num2);
	}

	func_0x1A4F9FED(iParam0, &(uParam2->f_diffmode));
	...
	*uParam4 = func_0x2758D2FB(iParam0, iParam1, Global_diffmode);
	return true;
}
...
int func_0x2758D2FB(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_0x88F491DA(iParam0))
	{
		if (_IS_EXCLUSIVE_CONTENT_UNLOCKED())
		{
			if (iParam0 == 205 && g_sMPTunables.f_diffmode || iParam0 != 205 && g_sMPTunables.f_diffmode)
				return 1;
...
BOOL func_0xFE55C623(int iParam0)
{
	...
	{
		case joaat("taco"):
			return _STAT_GET_PACKED_BOOL(42288, -1) || IS_BIT_SET(Global_diffmode, 9);
	
		case -1948949064:
			return _STAT_GET_PACKED_BOOL(28272, -1) && _STAT_GET_PACKED_BOOL(42289, -1) || IS_BIT_SET(Global_diffmode, 10);
	
		case -1321131184:
			return _STAT_GET_PACKED_BOOL(28272, -1) && _STAT_GET_PACKED_BOOL(42288, -1) || IS_BIT_SET(Global_diffmode, 11);
	
		case 2042703219:
			return _STAT_GET_PACKED_BOOL(28272, -1) && func_0x5137F6D6(137, -1) >= 10 || IS_BIT_SET(Global_diffmode, 12);
	
		case 1891140410:
			return _STAT_GET_PACKED_BOOL(28272, -1) && _STAT_GET_PACKED_BOOL(42016, -1) || IS_BIT_SET(Global_diffmode, 13);
	
		case joaat("predator"):
			return func_0x450FD245(PLAYER::PLAYER_ID(), 0) || IS_BIT_SET(Global_diffmode, 14);
	
		case joaat("cargobob5"):
			return _STAT_GET_PACKED_BOOL(51283, -1) || IS_BIT_SET(Global_diffmode, 15);
	
		case 858355070:
			return _STAT_GET_PACKED_BOOL(51285, -1) || IS_BIT_SET(Global_diffmode, 16);
	
		case 84351789:
			return _STAT_GET_PACKED_BOOL(54637, -1) || IS_BIT_SET(Global_diffmode, 17);
	
		case -536105557:
			return _STAT_GET_PACKED_BOOL(54638, -1) || IS_BIT_SET(Global_diffmode, 18);
...
BOOL func_0x450FD245(Player plParam0, int iParam1)
{
	if (func_0x6A46C9B4(plParam0))
	{
		switch (iParam1)
		{
			...
			case 1:
				return IS_BIT_SET(Global_diffmode[plParam0].f_diffmode, 7);
...
BOOL func_0xC61EC99(int iParam0)
{
	...
	{
		case -773802025:
			return _STAT_GET_PACKED_BOOL(42281, -1) || IS_BIT_SET(Global_diffmode, 28);
	
		case -1628000569:
			return _STAT_GET_PACKED_BOOL(42282, -1) || IS_BIT_SET(Global_diffmode, 29);
	
		case 1737348074:
			return func_0x5137F6D6(137, func_0x47FF56D2()) >= 5 || IS_BIT_SET(Global_diffmode, 30);
	
		case 1249425552:
			return _STAT_GET_PACKED_BOOL(42283, -1) || IS_BIT_SET(Global_diffmode, 31);
	
		case 1452003510:
			return _STAT_GET_PACKED_BOOL(42284, -1) || IS_BIT_SET(Global_diffmode, 0);
	
		case 1968807591:
			return _STAT_GET_PACKED_BOOL(42280, -1) || IS_BIT_SET(Global_diffmode, 1);
...
int func_0x91EBE676(int iParam0)
{
	switch (iParam0)
	{
		case -773802025:
...
BOOL func_0xA2F85ED3(int iParam0)
{
	...
	{
		case -1233767450:
			return func_0x15F41A9(true) || IS_BIT_SET(Global_diffmode, 18);
	
		case joaat("police4"):
			return func_0x57E551BE(1, false, true) || IS_BIT_SET(Global_diffmode, 20);
	
		case joaat("Police5"):
			return func_0x2F3FC5BE() || _STAT_GET_PACKED_BOOL(41942, -1) || IS_BIT_SET(Global_diffmode, 21);
	
		case joaat("riot"):
			return _STAT_GET_PACKED_BOOL(42123, -1) || IS_BIT_SET(Global_diffmode, 22);
	
		case -842765535:
			return _STAT_GET_PACKED_BOOL(42233, -1) || IS_BIT_SET(Global_diffmode, 23);
	
		case 728350375:
			return _STAT_GET_PACKED_BOOL(42234, -1) || IS_BIT_SET(Global_diffmode, 24);
...
{
	if (func_0x6A46C9B4(plParam0))
		return IS_BIT_SET(Global_diffmode[plParam0].f_diffmode, func_0x21E181EE(iParam1, bParam2));
...
BOOL func_0x2BCE241E(int iParam0)
{
	...
	{
		case 239897677:
			return func_0x9E830671(2, true, true) || IS_BIT_SET(Global_diffmode, 15);
	
		case joaat("squaddie"):
			return _STAT_GET_PACKED_BOOL(41656, -1) || IS_BIT_SET(Global_diffmode, 16);
	
		case joaat("manchez2"):
			return _STAT_GET_PACKED_BOOL(41671, -1) || IS_BIT_SET(Global_diffmode, 17);
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_diffmode[plParam0].f_diffmode.f_diffmode, func_0xE862C961(iParam1, bParam2));
...
BOOL func_0xDF32335C(int iParam0)
{
	...
	{
		case -1627077503:
			return func_0x2A5561CE(0, false) || IS_BIT_SET(Global_diffmode, 3);
	
		case -1035489563:
			return func_0x2A5561CE(4, false) || IS_BIT_SET(Global_diffmode, 4);
	
		case 669204833:
			return func_0x2A5561CE(10, false) || IS_BIT_SET(Global_diffmode, 5);
	
		case joaat("hotring"):
			return GET_MP_INT_CHARACTER_STAT(11845, -1) >= 10 || IS_BIT_SET(Global_diffmode, 6);
	
		case -131348178:
			return GET_MP_INT_CHARACTER_STAT(11845, -1) >= 20 || IS_BIT_SET(Global_diffmode, 7);
	
		case joaat("taxi"):
			return func_0x5137F6D6(158, -1) || IS_BIT_SET(Global_diffmode, 8);
	
		case -1576586413:
			return func_0x119B6B9F(false) || IS_BIT_SET(Global_diffmode, 9);
...
BOOL func_0x22D766A3(int iParam0)
{
	...
	{
		case joaat("kanjosj"):
			return _STAT_GET_PACKED_BOOL(34373, -1) || IS_BIT_SET(Global_diffmode, 10);
	
		case joaat("postlude"):
			return _STAT_GET_PACKED_BOOL(34374, -1) || IS_BIT_SET(Global_diffmode, 11);
	
		case joaat("greenwood"):
			return func_0xF8812672(0) || IS_BIT_SET(Global_diffmode, 12);
	
		case joaat("draugur"):
			return _STAT_GET_PACKED_BOOL(32366, -1) || func_0x9E830671(0, true, true) || IS_BIT_SET(Global_diffmode, 13);
	
		case joaat("conada"):
			return func_0xF8812672(5) || IS_BIT_SET(Global_diffmode, 14);
...
BOOL func_0xF01A40B0(int iParam0)
{
	...
	{
		case joaat("buffalo4"):
			return func_0xBBF82663() || IS_BIT_SET(Global_diffmode, 28);
	
		case joaat("granger2"):
			return func_0x90BEEB25(true) >= 5 || IS_BIT_SET(Global_diffmode, 29);
	
		case joaat("deity"):
			return func_0x90BEEB25(true) >= 10 || IS_BIT_SET(Global_diffmode, 30);
	
		case joaat("patriot3"):
			return func_0x90BEEB25(true) >= 15 || IS_BIT_SET(Global_diffmode, 31);
	
		case joaat("jubilee"):
			return func_0x90BEEB25(true) >= 20 || IS_BIT_SET(Global_diffmode, 0);
	
		case joaat("champion"):
			return func_0x7A476D65(11, true) || func_0x45A12DE4(true) || IS_BIT_SET(Global_diffmode, 1);
	
		case joaat("baller7"):
			return func_0x45A12DE4(true) || IS_BIT_SET(Global_diffmode, 2);
...
BOOL func_0x5DA07871(int iParam0)
{
	...
	{
		case joaat("euros"):
			return func_0xC05BBF25(PLAYER::PLAYER_ID()) || IS_BIT_SET(Global_diffmode, 0);
	
		case joaat("tailgater2"):
			return func_0x79E26E1F(PLAYER::PLAYER_ID()) || IS_BIT_SET(Global_diffmode, 1);
	
		case joaat("zr350"):
			return _STAT_GET_PACKED_BOOL(31810, -1) || IS_BIT_SET(Global_diffmode, 2);
	
		case joaat("comet6"):
			return _STAT_GET_PACKED_BOOL(31811, -1) || IS_BIT_SET(Global_diffmode, 3);
	
		case joaat("jester4"):
			return _STAT_GET_PACKED_BOOL(31812, -1) || IS_BIT_SET(Global_diffmode, 4);
	
		case joaat("vectre"):
			return _STAT_GET_PACKED_BOOL(31813, -1) || IS_BIT_SET(Global_diffmode, 5);
	
		case joaat("cypher"):
			return _STAT_GET_PACKED_BOOL(31814, -1) || IS_BIT_SET(Global_diffmode, 6);
	
		case joaat("growler"):
			return _STAT_GET_PACKED_BOOL(31815, -1) || IS_BIT_SET(Global_diffmode, 7);
	
		case joaat("calico"):
			return _STAT_GET_PACKED_BOOL(31816, -1) || IS_BIT_SET(Global_diffmode, 8);
	
		case joaat("remus"):
			return _STAT_GET_PACKED_BOOL(31817, -1) || IS_BIT_SET(Global_diffmode, 9);
	
		case joaat("dominator7"):
			return _STAT_GET_PACKED_BOOL(31818, -1) || IS_BIT_SET(Global_diffmode, 10);
	
		case joaat("futo2"):
			return _STAT_GET_PACKED_BOOL(31819, -1) || IS_BIT_SET(Global_diffmode, 11);
	
		case joaat("rt3000"):
			return _STAT_GET_PACKED_BOOL(31820, -1) || IS_BIT_SET(Global_diffmode, 12);
	
		case joaat("warrener2"):
			return _STAT_GET_PACKED_BOOL(31821, -1) || IS_BIT_SET(Global_diffmode, 13);
	
		case joaat("sultan3"):
			return _STAT_GET_PACKED_BOOL(31822, -1) || IS_BIT_SET(Global_diffmode, 14);
	
		case joaat("dominator8"):
			return _STAT_GET_PACKED_BOOL(31823, -1) || IS_BIT_SET(Global_diffmode, 15);
	
		case joaat("previon"):
			return _STAT_GET_PACKED_BOOL(31824, -1) || IS_BIT_SET(Global_diffmode, 16);
	
		case joaat("kanjosj"):
			return _STAT_GET_PACKED_BOOL(34373, -1) || IS_BIT_SET(Global_diffmode, 17);
	
		case joaat("postlude"):
			return _STAT_GET_PACKED_BOOL(34374, -1) || IS_BIT_SET(Global_diffmode, 18);
...
BOOL func_0xC05BBF25(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		if (IS_BIT_SET(GlobalplayerBD_FM[plParam0].f_diffmode.f_diffmode.f_diffmode, 17))
			return true;
...
BOOL func_0x9E8E0444(int iParam0)
{
	...
	{
		case joaat("winky"):
			if (func_0xCF604538(PLAYER::PLAYER_ID(), 0) || func_0x9D2FA4AB(false) || IS_BIT_SET(Global_diffmode, 19))
				return true;
			break;
	
		case joaat("brioso2"):
			if (func_0x23C83125(PLAYER::PLAYER_ID()) || IS_BIT_SET(Global_diffmode, 20))
				return true;
			break;
	
		case joaat("vetir"):
			if (func_0x5137F6D6(281, -1) || IS_BIT_SET(Global_diffmode, 21))
				return true;
			break;
	
		case joaat("longfin"):
			if (func_0x5137F6D6(282, -1) || IS_BIT_SET(Global_diffmode, 22))
				return true;
			break;
	
		case joaat("annihilator2"):
			if (func_0x5137F6D6(283, -1) || IS_BIT_SET(Global_diffmode, 23))
				return true;
			break;
	
		case joaat("alkonost"):
			if (func_0x5137F6D6(284, -1) || IS_BIT_SET(Global_diffmode, 24))
				return true;
			break;
	
		case joaat("patrolboat"):
			if (func_0x5137F6D6(285, -1) || IS_BIT_SET(Global_diffmode, 25))
				return true;
			break;
	
		case joaat("weevil"):
			if (func_0x7A476D65(0, true) && func_0x7A476D65(1, true) && func_0x7A476D65(2, true) || IS_BIT_SET(Global_diffmode, 26))
				return true;
			break;
	
		case joaat("italirsx"):
			if (func_0x7A476D65(3, true) || IS_BIT_SET(Global_diffmode, 27))
				return true;
			break;
	}
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_diffmode[plParam0].f_diffmode, iParam1);
...
BOOL func_0xED8023F5(int iParam0)
{
	...
	{
		case joaat("firetruk"):
			if (IS_BIT_SET(num, 0) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("burrito2"):
			if (IS_BIT_SET(num, 1) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("boxville"):
			if (IS_BIT_SET(num, 2) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("stockade"):
			if (IS_BIT_SET(num, 3) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("asbo"):
			if (IS_BIT_SET(num, 4) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("kanjo"):
			if (IS_BIT_SET(num, 5) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("everon"):
			if (IS_BIT_SET(num, 6) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("retinue2"):
			if (IS_BIT_SET(num, 7) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("yosemite2"):
			if (IS_BIT_SET(num, 8) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("sugoi"):
			if (IS_BIT_SET(num, 9) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("sultan2"):
			if (IS_BIT_SET(num, 10) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("outlaw"):
			if (IS_BIT_SET(num, 11) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("vagrant"):
			if (IS_BIT_SET(num, 12) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("komoda"):
			if (IS_BIT_SET(num, 13) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("stryder"):
			if (IS_BIT_SET(num, 14) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("furia"):
			if (IS_BIT_SET(num, 15) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("zhaba"):
			if (IS_BIT_SET(num, 16) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("jugular"):
			if (IS_BIT_SET(num, 17) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("sentinel3"):
			if (IS_BIT_SET(num, 18) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("gauntlet3"):
			if (IS_BIT_SET(num, 19) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("ellie"):
			if (IS_BIT_SET(num, 20) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("defiler"):
			if (IS_BIT_SET(num, 21) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("manchez"):
			if (IS_BIT_SET(num, 22) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
...
BOOL func_0xE53900A8(int iParam0)
{
	...
	{
		case joaat("mule4"):
			if (GET_MP_INT_CHARACTER_STAT(7233, -1) >= func_0xF591FF90(iParam0) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("oppressor2"):
			if (_STAT_GET_PACKED_INT(22050, -1) >= func_0xF591FF90(iParam0) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("pbus2"):
			if (IS_BIT_SET(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode.f_diffmode, 1) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
		...
		case joaat("patriot2"):
			if (GET_MP_INT_CHARACTER_STAT(7231, -1) >= func_0xF591FF90(iParam0) || g_sMPTunables.f_diffmode)
				return true;
			else
				return false;
			break;
...
int func_0xF591FF90(int iParam0)
{
	...
	{
		case joaat("mule4"):
			return g_sMPTunables.f_diffmode;
	...
	if (NETWORK::NETWORK_IS_SIGNED_IN())
	{
		if (NETWORK::NETWORK_HAS_VALID_ROS_CREDENTIALS())
		{
			if (NETWORK::NETWORK_HAS_ROS_PRIVILEGE_PLAYED_LAST_GEN())
			{
				...
				MISC::SET_BIT(&Global_diffmode, 2);
				MISC::SET_BIT(&Global_diffmode, 4);
				MISC::SET_BIT(&Global_diffmode, 6);
...
BOOL func_0xAF3D3332()
{
	...
	if (IS_BIT_SET(Global_diffmode, 5))
		if (IS_BIT_SET(Global_diffmode, 1) || IS_BIT_SET(Global_diffmode, 3))
			return 1;
		else
			return 0;
	...
	if (NETWORK::NETWORK_IS_SIGNED_IN())
	{
		if (NETWORK::NETWORK_HAS_VALID_ROS_CREDENTIALS())
		{
			if (NETWORK::NETWORK_HAS_ROS_PRIVILEGE_SPECIAL_EDITION_CONTENT())
			{
				...
				MISC::SET_BIT(&Global_diffmode, 5);
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
				uParam1->f_diffmode = PLAYER::PLAYER_ID();
			...
			if (func_0x60F4FB46(ENTITY::GET_ENTITY_MODEL(veParam0)))
			{
				if (IS_BIT_SET(uParam1->f_diffmode, 0) || func_0xE48228D0(ENTITY::GET_ENTITY_MODEL(veParam0)))
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, false, true);
					func_0xC8522672(veParam0);
				}
				else
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, true, true);
					func_0x67667FA6(veParam0);
				}
			}
		
			if (!(uParam1->f_diffmode == -1) && uParam1->f_diffmode[14] == -1)
				AUDIO::OVERRIDE_VEH_HORN(veParam0, true, uParam1->f_diffmode);
		
			if (!(uParam1->f_diffmode == -1))
				AUDIO::SET_VEHICLE_HORN_SOUND_INDEX(veParam0, uParam1->f_diffmode);
		
			if (func_0x1B3B2773(uParam1->f_diffmode, &num) && uParam1->f_diffmode != num)
				uParam1->f_diffmode = num;
		
			VEHICLE::SET_VEHICLE_ENVEFF_SCALE(veParam0, uParam1->f_diffmode);
		
			if (uParam1->f_diffmode >= 0)
				VEHICLE::SET_VEHICLE_EXTRA_COLOUR_5(veParam0, uParam1->f_diffmode);
		
			if (uParam1->f_diffmode >= 0)
				VEHICLE::SET_VEHICLE_EXTRA_COLOUR_6(veParam0, uParam1->f_diffmode);
		
			if (func_0xEB13AB9D(veParam0))
				func_0x47F85C31(veParam0, func_0x8C841BCD(uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode));
		
			if (VEHICLE::GET_VEHICLE_LIVERY2_COUNT(veParam0) > 1 && uParam1->f_diffmode >= 0)
				VEHICLE::SET_VEHICLE_LIVERY2(veParam0, uParam1->f_diffmode);
		
			if (IS_BIT_SET(uParam1->f_diffmode, 0))
				func_0x26C20EE4(veParam0, &(uParam1->f_diffmode));
			...
			switch (uParam1->f_diffmode)
			{
				case 0:
					break;
			
				case 1:
					if (IS_BIT_SET(uParam1->f_diffmode, 1) && IS_BIT_SET(uParam1->f_diffmode, 2))
					{
						if (IS_BIT_SET(uParam1->f_diffmode, 3))
						{
						}
					}
				...
				case 2:
					if (IS_BIT_SET(uParam1->f_diffmode, 1) && IS_BIT_SET(uParam1->f_diffmode, 2))
						...
						if (IS_GAMER_HANDLE_VALID(uParam1->f_diffmode) && NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&(uParam1->f_diffmode)))
							DECORATOR::DECOR_SET_INT(veParam0, "Veh_Modded_By_Player", NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&(uParam1->f_diffmode))));
						else
...
void func_0xCAA4A78(Vehicle veParam0)
{
	...
	if (g_sMPTunables.f_diffmode)
	{
		if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		{
			...
			{
				entityModel = ENTITY::GET_ENTITY_MODEL(veParam0);
				entityModel.f_diffmode = MISC::GET_HASH_KEY(VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT(veParam0));
			
				if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("RandomID", INT))
				{
					if (!DECORATOR::DECOR_EXIST_ON(veParam0, "RandomID"))
					{
						entityModel.f_diffmode = MISC::GET_RANDOM_INT_IN_RANGE(0, 65535);
						DECORATOR::DECOR_SET_INT(veParam0, "RandomID", entityModel.f_diffmode);
					}
					else
					{
						entityModel.f_diffmode = DECORATOR::DECOR_GET_INT(veParam0, "RandomID");
					}
				}
...
void func_0x3782EFFB(var uParam0, var uParam1, var uParam2)
{
	...
	eventData.f_diffmode = uParam0;
	eventData.f_diffmode.f_diffmode = uParam0.f_diffmode;
	eventData.f_diffmode.f_diffmode = uParam0.f_diffmode;
...
BOOL func_0xA45BEB30(int iParam0, int iParam1, BOOL bParam2)
{
	...
	if (bParam2)
		return IS_BIT_SET(g_sShopSettings.f_diffmode[iParam0], iParam1);
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (func_0x21D64237() == 0)
			return IS_BIT_SET(GET_MP_INT_CHARACTER_STAT(func_0x28E83966(iParam0), -1), iParam1);
	else
		return IS_BIT_SET(SP_save_structure.f_diffmode[iParam0], iParam1);
...
{
	return g_sShopSettings.f_diffmode > 0;
}
...
BOOL func_0xBC57DF9D(var uParam0, Player plParam1)
{
	...
	if (g_TransitionData.f_diffmode != 0 || VEHICLE::GET_VEHICLE_IS_DUMMY(*uParam0))
	{
		Global_diffmode.f_diffmode = VEHICLE::GET_FAKE_SUSPENSION_LOWERING_AMOUNT(*uParam0);
	
		if (Global_diffmode.f_diffmode < 0f)
			Global_diffmode.f_diffmode = 0f;
	}

	func_0x16E94792(*uParam0, &Global_diffmode, &(Global_diffmode.f_diffmode), &(Global_diffmode.f_diffmode), &(Global_diffmode.f_diffmode), &(Global_diffmode.f_diffmode));
	Global_diffmode.f_diffmode.f_diffmode = Global_diffmode.f_diffmode.f_diffmode - Global_diffmode.f_diffmode;

	if (Global_diffmode.f_diffmode.f_diffmode < 0f)
		Global_diffmode.f_diffmode = 1;

	Global_diffmode.f_diffmode = 200;
	...
	if (Global_diffmode.f_diffmode)
	{
		if (func_0x947E8C7E(uParam0, plParam1, Global_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, 0, Global_diffmode.f_diffmode))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_diffmode = NETWORK::GET_NETWORK_TIME();
			else
				Global_diffmode = MISC::GET_GAME_TIMER();
	...
	{
		Global_diffmode.f_diffmode = { Global_diffmode.f_diffmode };
		Global_diffmode.f_diffmode = Global_diffmode.f_diffmode * -1f;
		Global_diffmode.f_diffmode = { Global_diffmode.f_diffmode };
		Global_diffmode.f_diffmode = Global_diffmode.f_diffmode * -1f;
		Global_diffmode.f_diffmode = { Global_diffmode.f_diffmode };
		Global_diffmode.f_diffmode.f_diffmode = Global_diffmode.f_diffmode.f_diffmode * -1f;
		Global_diffmode.f_diffmode.f_diffmode = Global_diffmode.f_diffmode.f_diffmode * -1f;
	
		if (!GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(*uParam0, 0))
			Global_diffmode.f_diffmode = GRAPHICS::GET_VEHICLE_CREW_EMBLEM_REQUEST_STATE(*uParam0, 0);
		else
			Global_diffmode.f_diffmode = 3;
	
		Global_diffmode.f_diffmode = GRAPHICS::GET_VEHICLE_CREW_EMBLEM_REQUEST_STATE(*uParam0, 1);
		...
		if (Global_diffmode.f_diffmode == 0 && func_0x947E8C7E(uParam0, plParam1, Global_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, 0, Global_diffmode.f_diffmode) || Global_diffmode.f_diffmode != 0 && Global_diffmode.f_diffmode == 0 && func_0x947E8C7E(uParam0, plParam1, Global_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, Global_diffmode.f_diffmode, 1, Global_diffmode.f_diffmode) || Global_diffmode.f_diffmode != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_diffmode = NETWORK::GET_NETWORK_TIME();
			else
...
int func_0x16E94792(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5)
{
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_0x2D46096D(Global_diffmode, 0f, 0f, 0f, false) && !func_0x2D46096D(Global_diffmode, 0f, 0f, 0f, false) && !func_0x2D46096D(Global_diffmode, 0f, 0f, 0f, false) && !(Global_diffmode == 0f))
	{
		*uParam2 = { Global_diffmode };
		*uParam3 = { Global_diffmode };
		*uParam4 = { Global_diffmode };
		*fParam5 = Global_diffmode;
		return 1;
	}
...
{
	Global_diffmode = 0;
	Global_diffmode.f_diffmode = { 0f, 0f, 0f };
	Global_diffmode.f_diffmode = { 0f, 0f, 0f };
	Global_diffmode.f_diffmode = { 0f, 0f, 0f };
	Global_diffmode.f_diffmode = 0f;
	Global_diffmode.f_diffmode = 0f;
...
BOOL func_0xC9297803(Vehicle veParam0, Any* panParam1)
{
	...
	{
		num = g_savedMPGlobalsNew.g_savedMPGlobals[func_0xF9396AAC()].f_diffmode.f_diffmode;
	
		if (num > -1 && num < 547)
			if (IS_BIT_SET(Global_diffmode[num].f_diffmode, 8))
				flag = true;
	}
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_0xA4C8B8D7(plParam0) && GlobalplayerBD[plParam0].f_diffmode.f_diffmode == plParam0)
			return true;
...
BOOL func_0xA4C8B8D7(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 22;
...
void func_0x67667FA6(Vehicle veParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
void func_0xC8522672(Vehicle veParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
void func_0x3234A2AB(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		{
			if (MISC::GET_HASH_KEY(&(uParam1->f_diffmode)) != 0)
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(veParam0, &(uParam1->f_diffmode));
		
			if (*uParam1 >= 0 && *uParam1 < VEHICLE::GET_NUMBER_OF_VEHICLE_NUMBER_PLATES())
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0, *uParam1);
		}
	
		if (uParam1->f_diffmode == joaat("sovereign"))
		{
			uParam1->f_diffmode = 111;
			uParam1->f_diffmode = 111;
			uParam1->f_diffmode = 111;
		}
		else if (uParam1->f_diffmode == joaat("casco"))
		{
			num = 1;
		
			if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(num + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(num + 1));
			}
		}
		else if (uParam1->f_diffmode == joaat("sandking") || uParam1->f_diffmode == joaat("sandking2"))
		{
			num2 = 1;
		
			if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(num2 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(num2 + 1));
			}
		}
		else if (uParam1->f_diffmode == joaat("formula") || uParam1->f_diffmode == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(i)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(i));
				}
			}
		}
		else if (uParam1->f_diffmode == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(j)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(j));
				}
			}
		}
		else if (uParam1->f_diffmode == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(k)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(k));
					}
				}
			}
		}
		else if (uParam1->f_diffmode == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(l)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(l));
				}
			}
		}
		else if (uParam1->f_diffmode == joaat("dinghy5"))
		{
			if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(4));
			}
		}
		else if (uParam1->f_diffmode == joaat("coquette4"))
		{
			if (VEHICLE::GET_VEHICLE_MOD(veParam0, 10) != 0)
				MISC::SET_BIT(&(uParam1->f_diffmode), 0);
		}
		else if (uParam1->f_diffmode == joaat("yosemite2"))
		{
			MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(1));
		}
		else if (uParam1->f_diffmode == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(m)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_diffmode), func_0xEE599357(m));
				}
			}
		}
	
		if (uParam1->f_diffmode == joaat("nightshark"))
		{
		...
		if (IS_BIT_SET(uParam1->f_diffmode, 13))
			VEHICLE::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR(veParam0, uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode);
		else
			VEHICLE::CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR(veParam0);
	
		if (IS_BIT_SET(uParam1->f_diffmode, 12))
			VEHICLE::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR(veParam0, uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode);
		else
			VEHICLE::CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR(veParam0);
	
		if (uParam1->f_diffmode != -1 && uParam1->f_diffmode != -1)
		{
			if (func_0xF0601AB8(uParam1->f_diffmode) || func_0xF0601AB8(uParam1->f_diffmode))
			{
			}
			else
			{
				VEHICLE::SET_VEHICLE_COLOURS(veParam0, uParam1->f_diffmode, uParam1->f_diffmode);
			}
		}
		...
		VEHICLE::SET_VEHICLE_EXTRA_COLOURS(veParam0, uParam1->f_diffmode, uParam1->f_diffmode);
	
		if (IS_BIT_SET(uParam1->f_diffmode, 15) || func_0xEEF32E6(veParam0) || uParam1->f_diffmode == 0 && uParam1->f_diffmode == 0 && uParam1->f_diffmode == 0 && uParam1->f_diffmode[20] > 0 && DLC::IS_DLC_PRESENT(joaat("mpindependence")))
		{
			uParam1->f_diffmode = 0;
			uParam1->f_diffmode = 0;
			uParam1->f_diffmode = 0;
		}
		else if (uParam1->f_diffmode == 0 && uParam1->f_diffmode == 0 && uParam1->f_diffmode == 0)
		{
			uParam1->f_diffmode = 255;
			uParam1->f_diffmode = 255;
			uParam1->f_diffmode = 255;
		}
	
		VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(veParam0, uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode);
	
		if (uParam1->f_diffmode == -1 && !func_0x5000025C(uParam1->f_diffmode))
		{
		...
		{
			VEHICLE::SET_VEHICLE_WINDOW_TINT(veParam0, 0);
			VEHICLE::SET_VEHICLE_WINDOW_TINT(veParam0, uParam1->f_diffmode);
		}
	
		if (IS_BIT_SET(uParam1->f_diffmode, 9))
		{
			VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(veParam0, false);
			VEHICLE::SET_DRIFT_TYRES(veParam0, false);
		}
		...
		if (bParam2)
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(veParam0, uParam1->f_diffmode);
	
		VEHICLE::SET_VEHICLE_NEON_COLOUR(veParam0, uParam1->f_diffmode, uParam1->f_diffmode, uParam1->f_diffmode);
		VEHICLE::SET_VEHICLE_NEON_ENABLED(veParam0, 2, IS_BIT_SET(uParam1->f_diffmode, 28));
		VEHICLE::SET_VEHICLE_NEON_ENABLED(veParam0, 3, IS_BIT_SET(uParam1->f_diffmode, 29));
		VEHICLE::SET_VEHICLE_NEON_ENABLED(veParam0, 0, IS_BIT_SET(uParam1->f_diffmode, 30));
		VEHICLE::SET_VEHICLE_NEON_ENABLED(veParam0, 1, IS_BIT_SET(uParam1->f_diffmode, 31));
		VEHICLE::SET_VEHICLE_IS_STOLEN(veParam0, IS_BIT_SET(uParam1->f_diffmode, 10));
	
		if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(veParam0) > 1 && uParam1->f_diffmode >= 0)
			VEHICLE::SET_VEHICLE_LIVERY(veParam0, uParam1->f_diffmode);
	
		if (uParam1->f_diffmode > -1 && uParam1->f_diffmode < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_diffmode == 6)
						func_0x4F43FC2B(veParam0, uParam1->f_diffmode);
				else
					func_0x4F43FC2B(veParam0, uParam1->f_diffmode);
	
		if (VEHICLE::IS_VEHICLE_A_CONVERTIBLE(veParam0, false))
			if (uParam1->f_diffmode == 0 || uParam1->f_diffmode == 3 || uParam1->f_diffmode == 5)
				VEHICLE::RAISE_CONVERTIBLE_ROOF(veParam0, true);
			else
				VEHICLE::LOWER_CONVERTIBLE_ROOF(veParam0, true);
	
		if (bParam3)
			func_0x5C9EC0F7(&veParam0, &(uParam1->f_diffmode), &(uParam1->f_diffmode));
	
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_diffmode) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_diffmode))
		{
			for (n = 0; n <= 11; n = n + 1)
			{
				if (IS_BIT_SET(uParam1->f_diffmode, func_0xEE599357(n + 1)))
		...
		if (func_0x599C0723() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_diffmode) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_0x9AA99395(true)))
			if (!IS_BIT_SET(uParam1->f_diffmode, 23))
				if (!IS_BIT_SET(uParam1->f_diffmode, 22) && func_0x64EBC58(veParam0, 5f))
		...
		if (IS_BIT_SET(uParam1->f_diffmode, 27))
...
BOOL func_0x64EBC58(Vehicle veParam0, float fParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
		...
		if (MISC::GET_GROUND_Z_FOR_3D_COORD(entityCoords, &groundZ, false, false))
			if (MISC::ABSF(entityCoords.f_diffmode - groundZ) > fParam1)
				return true;
		else if (entityCoords.f_diffmode > PATHFIND::GET_APPROX_FLOOR_FOR_POINT(entityCoords, entityCoords.f_diffmode) + fParam1)
			return true;
		else if (entityCoords.f_diffmode > 300f)
			return true;
	}
...
{
	if (*g_FMMC_STRUCT.f_diffmode == 6 || *g_FMMC_STRUCT.f_diffmode == 7 || *g_FMMC_STRUCT.f_diffmode == 18 || *g_FMMC_STRUCT.f_diffmode == 19 && g_FMMC_STRUCT.f_diffmode == 20)
		return false;

	if (func_0x7F5F619C(7))
		if (func_0xE40D6326(MPGlobals.f_diffmode.f_diffmode) || func_0x16FCD261(MPGlobals.f_diffmode.f_diffmode))
			return false;
...
BOOL func_0x16FCD261(int iParam0)
{
	...
	if (num != -1)
		return Global_diffmode[num].f_diffmode.f_diffmode != 0;
...
{
	return IS_BIT_SET(globalPlayerBD_FM_3[iParam0].f_diffmode.f_diffmode, iParam1);
}
...
BOOL func_0xEEF32E6(Vehicle veParam0)
{
	int _int;
...
int func_0x2D543B60(int iParam0)
{
	...
	if (iParam0 == joaat("bifta"))
		...
		return 244;
	else if (iParam0 == Global_diffmode)
		return 245;
...
void func_0xA7D24319()
{
	...
	if (MPGlobalsAmbience.f_diffmode < 6)
		return;
...
{
	Global_diffmode = !NETWORK::NETWORK_IS_ACTIVITY_SESSION();
	Global_diffmode.f_diffmode[0] = { 369.762f, -54.702f, 98.869f };
	Global_diffmode.f_diffmode[0] = { 397.561f, -64.872f, 115.581f };
	Global_diffmode.f_diffmode[0] = 35f;
	Global_diffmode.f_diffmode[1] = { -1034.964f, -434.189f, 59.368f };
	Global_diffmode.f_diffmode[1] = { -1008.375f, -421.17f, 76.507f };
	Global_diffmode.f_diffmode[1] = 35f;
	Global_diffmode.f_diffmode[2] = { -573.272f, -717.097f, 108.513f };
	Global_diffmode.f_diffmode[2] = { -602.873f, -716.668f, 125.263f };
	Global_diffmode.f_diffmode[2] = 35f;
	Global_diffmode.f_diffmode[3] = { -1004.441f, -775.809f, 57.428f };
	Global_diffmode.f_diffmode[3] = { -1004.215f, -746.208f, 74.382f };
	Global_diffmode.f_diffmode[3] = 35f;
	return;
}
...
void func_0xC65DAA2()
{
	...
	if (func_0x4C17DBA0() && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(vehiclePedIsIn) && VEHICLE::IS_VEHICLE_MODEL(vehiclePedIsIn, -1321131184) && g_sShopSettings.f_diffmode == 40 && g_sMenuData.f_diffmode == 0)
		{
			_STOPWATCH_RESET(&uLocal_diffmode, false, false);
...
{
	if (IS_BIT_SET(MPGlobalsAmbience.f_diffmode, 16) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_vehicle_spawn")) <= 0 || !func_0x6F05646C())
	{
		MISC::CLEAR_BIT(&(MPGlobalsAmbience.f_diffmode), 16);
...
BOOL func_0x6F05646C()
{
	...
	if (MPGlobals.f_diffmode.f_diffmode)
		return false;
...
BOOL func_0x4E5E8E48(Player plParam0)
{
	...
	return IS_BIT_SET(GlobalplayerBD_FM[plParam0].f_diffmode.f_diffmode.f_diffmode, 3);
}

void func_0x426AB617()
{
	if (_STOPWATCH_IS_INITIALIZED(&(g_TransitionSessionNonResetVars.f_diffmode.f_diffmode)))
		if (_STOPWATCH_GET_TIME_PASSED(&(g_TransitionSessionNonResetVars.f_diffmode.f_diffmode), false, false) > 55000)
			if (func_0xA3993EC8(false))
				_STOPWATCH_DESTROY(&(g_TransitionSessionNonResetVars.f_diffmode.f_diffmode));
...
BOOL func_0xA3993EC8(BOOL bParam0)
{
	...
	if (func_0x6A46C9B4(player))
		if (func_0xDDB0D9A1(&(GlobalplayerBD[player].f_diffmode), 0) || func_0x135A99C7(player) || func_0xFE840448(player) || func_0xB2831D42(player) || func_0x296323FE(player) || func_0xA4C8B8D7(player) || func_0x88D363EA(player) || func_0xE575EF3(player) || func_0xB3E29AC5(player) || func_0xF622C929(player) && func_0x1387ACAA(player) || func_0x589A6463(player) || func_0xF8DB13F7(player) || func_0x70532CF7(player) || func_0x8622182D(player) || func_0x4FC9F912(player))
			return true;
...
BOOL _IS_PLAYER_IN_MUSIC_LOCKER(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 19;
...
BOOL func_0xDB07D527(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 15;
...
BOOL func_0xAE0E4D65(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 16;
...
BOOL func_0xB5AF000F(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 14;
...
BOOL func_0x4FC9F912(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 31;
...
BOOL func_0x70532CF7(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 29;
...
BOOL func_0xF8DB13F7(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			return GlobalplayerBD[plParam0].f_diffmode.f_diffmode == 161;
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(GlobalplayerBD[plParam0].f_diffmode.f_diffmode, 26);
...
BOOL func_0x928E8225(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1 && GlobalplayerBD[plParam0].f_diffmode.f_diffmode != _INVALID_PLAYER_INDEX())
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 25;
...
BOOL func_0xB3E29AC5(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 26;
...
BOOL func_0xE575EF3(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 21;
...
BOOL func_0x296323FE(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 23;
...
BOOL func_0xFE840448(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1)
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 17;

	return false;
}

BOOL func_0x135A99C7(Player plParam0)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (GlobalplayerBD[plParam0].f_diffmode.f_diffmode != -1 && GlobalplayerBD[plParam0].f_diffmode.f_diffmode != _INVALID_PLAYER_INDEX())
				return func_0xEE599357(GlobalplayerBD[plParam0].f_diffmode.f_diffmode) == 20;
...
void func_0xD90CE4E3()
{
	...
	if (func_0x65FE6645(PLAYER::PLAYER_ID()) && func_0xB4CE8E51(PLAYER::PLAYER_ID(), false) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
	{
		...
		g_SimpleInteriorData.f_diffmode = 3;
		func_0xF8C0ED23(0);
	}
...
{
	return g_SimpleInteriorData.f_diffmode;
}

void func_0x82CF9798(BOOL bParam0)
{
	if (bParam0)
		if (!IS_BIT_SET(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode, 13))
			MISC::SET_BIT(&(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode), 13);
	else if (IS_BIT_SET(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode, 13))
		MISC::CLEAR_BIT(&(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode), 13);
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(GlobalplayerBD_FM[plParam0].f_diffmode.f_diffmode, 13);
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_0x8622182D(plParam0) && GlobalplayerBD[plParam0].f_diffmode.f_diffmode == plParam0)
			return true;
...
void func_0xD9928548()
{
	...
	if (func_0xB4CE8E51(PLAYER::PLAYER_ID(), false) && func_0x3654624B(PLAYER::PLAYER_ID(), false) && func_0x5726FF74(PLAYER::PLAYER_ID()) != -1)
	{
		...
		{
			bLocal_diffmode = true;
			bLocal_diffmode = _STAT_GET_PACKED_BOOL(9548, -1);
		}
	}
	else if (bLocal_diffmode)
	{
...
void func_0xD8967A8D()
{
	...
	if (bLocal_diffmode && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(2073234978) <= 0)
	{
...
void func_0x943E3046()
{
	...
	if (num != -1 && MPGlobalsAmbience.f_diffmode == num)
	{
		if (func_0x5976C0FC() && func_0x741C3B43(PLAYER::PLAYER_ID()) == 0)
		{
			globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode = 0;
			globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode = _INVALID_PLAYER_INDEX();
			globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode.f_diffmode = -1;
		
			if (IS_BIT_SET(globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode, 4))
				MISC::CLEAR_BIT(&(globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode), 4);
		
			if (IS_BIT_SET(globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode, 6))
				MISC::CLEAR_BIT(&(globalPlayerBD_FM_3[PLAYER::PLAYER_ID()].f_diffmode), 6);
		}
	}
...
int func_0x741C3B43(Player plParam0)
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 5; i = i + 1)
		{
			if (func_0xD95B534C(globalPlayerBD_FM_3[plParam0].f_diffmode.f_diffmode[i]))
				num = num + 1;
		}
	}
...
{
	return plParam0.f_diffmode != -1 && plParam0 != _INVALID_PLAYER_INDEX();
}
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_0xD95B534C(globalPlayerBD_FM_3[plParam0].f_diffmode.f_diffmode) || IS_BIT_SET(globalPlayerBD_FM_3[plParam0].f_diffmode, 4))
			return 1;
...
void func_0x9AB66A8E()
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		if (!bLocal_diffmode && Global_diffmode)
		{
			if (func_0x8D8B981E())
			{
				if (!func_0x974E48B4() && !func_0x1B04F1B9(1) || func_0x29FAC0E6())
				{
					...
					else if (!_STOPWATCH_HAS_TIME_PASSED(&uLocal_diffmode, *g_sMPTunables.f_diffmode - 1000, false))
					{
						return;
					}
					else if (GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode == 1)
					{
						bLocal_diffmode = true;
						func_0x92C2AC43();
					}
...
{
	Join_session_trigger.f_diffmode = 1;
	return;
}

BOOL func_0x29FAC0E6()
{
	return IS_BIT_SET(Join_session_trigger.f_diffmode, 0);
}

BOOL func_0x1B04F1B9(int iParam0)
{
	return Global_diffmode.f_diffmode[iParam0].f_diffmode;
}

BOOL func_0x974E48B4()
{
	return Join_session_trigger.f_diffmode;
}

BOOL func_0x8D8B981E()
{
	return IS_BIT_SET(GlobalplayerBD_FM[PLAYER::PLAYER_ID()].f_diffmode.f_diffmode, 5);
}
...
void func_0x605F91F9()
{
	...
	{
		if (!bLocal_diffmode && !MPGlobals.f_diffmode.f_diffmode)
		{
			MPGlobals.f_diffmode.f_diffmode = 1;
			bLocal_diffmode = true;
		}
	
		if (passive.f_diffmode)
		{
			func_0xB7B0B293();
