...
{
	if (/*Global_1574582*/passive.f_6 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
...
{
	if (Global_2625163 || func_0x47FF56D2() == 2)
		return 1;
...
{
	return IS_BIT_SET(/*Global_2684718*/Join_session_trigger, 20);
}
